...
function ie(e, t, n = {}) {
	if (t !== void 0) return I(e, t, (e, { index: t }) => t);
	let r = [
...
function H(e, t) {
	let n = G(t.fontScale, 1), r = W(t.fontSize, De) * n, i = W(t.fontWeight, Oe), a = Me(t.letterSpacing, 0) * n;
	if (!e || r === 0) return {
		x: 0,
		y: 0,
		width: 0,
...
function Pe(e, t, n, r, i = e.points) {
	let a = Ie(e), o = i === e.points ? void 0 : new Set(i);
	if (!a.targets.length && !a.attachedPoints.size) return Ne(i, t, n, r);
	let s = Fe(e, t, n, i);
	if (s) return s.point;
...
function ft(e, t, n, r) {
	let i = Wt(t.width), a = Wt(t.height), o = {
		...r,
...
function jt(e, t, n, r, i, a, o) {
	...
	let f = Pt(l), p = Pt(u), m = e.y + e.height, h = e.x, g = Ot(a ? Y : 0), _ = (t) => Ct(g, e, t, o), v = l?.ticks === !1 ? [] : t.x.ticks, y = u?.ticks === !1 ? [] : t.y.ticks, b = X(l?.ticks === !1 ? 0 : l?.ticks?.size ?? 4), x = X(u?.ticks === !1 ? 0 : u?.ticks?.size ?? 4), S = X(l?.ticks === !1 ? 0 : l?.ticks?.padding ?? 4), C = X(u?.ticks === !1 ? 0 : u?.ticks?.padding ?? 4), w = f === !1 ? [] : Rt("x", Lt(t.x, n.x, f), e, b, S, f, t.x.bandwidth, i, r, o), T = p === !1 ? [] : Rt("y", Lt(t.y, n.y, p), e, x, C, p, t.y.bandwidth, i, r, o), E = f === !1 ? [] : zt(w, f, t.x.type === "band"), D = p === !1 ? [] : zt(T, p, !1);
	for (let t of s ? v : []) {
		let n = M(t.value);
		b > 0 && d.push({
			kind: "rule",
...
function Rt(e, t, n, r, i, a, o, s, c, l) {
	...
	return t.map((t, s) => {
		let d = {
			...
			position: t.position,
			bandwidth: o
		}, f = a.rotate, p = Z(a.fontSize, d) ?? u, m = Z(a.fontWeight, d), h = Z(a.opacity, d), g = Z(a.dx, d) ?? 0, _ = Z(a.dy, d) ?? 0, v = e === "y" || (f ?? 0) < 0 ? "end" : (f ?? 0) > 0 ? "start" : "middle", y = Z(a.anchor, d) ?? v, b = e === "x" ? {
			kind: "label",
...
function zt(e, t, n) {
	...
	if ((r.priority === "ends" || n) && o.length) {
		let e = o[0], t = o.at(-1);
		Vt(e, a, i) || a.push(e), t !== e && !Vt(t, a, i) && a.push(t);
	}
	let s = Bt(o.filter((e) => !a.includes(e)));
	for (let e of s) Vt(e, a, i) || a.push(e);
	let c = new Set(a);
...
function Vt(e, t, n) {
	return t.some((t) => Ht(e.bounds, t.bounds, n));
}
function Ht(e, t, n) {
...
function Jt(e) {
	let t = e.ownerDocument.defaultView, n = t?.CanvasRenderingContext2D ? e.ownerDocument.createElement("canvas").getContext("2d") : null, r = o(), i = Zt(r), a = /* @__PURE__ */ new Map();
	return {
		measureText(e, t) {
			if (!n) return H(e, t);
	...
	function o() {
		...
		return {
			...
			stretch: Qt(n?.fontStretch),
			weight: n?.fontWeight || "400",
			direction: n?.direction === "rtl" ? "rtl" : n?.direction === "ltr" ? "ltr" : "inherit",
			letterSpacing: $t(n?.letterSpacing)
		};
	}
}
function Yt(e, t, n) {
	let r = en(n.fontScale, 1), i = n.fontSize * r, a = n.fontWeight ?? t;
	e.font = [
		n.fontStyle,
		a,
		`${i}px`,
		n.fontFamily
	].join(" "), "fontStretch" in e && (e.fontStretch = Qt(n.fontStretch)), e.textAlign = n.anchor === "middle" ? "center" : n.anchor, e.textBaseline = n.baseline === "auto" ? "alphabetic" : n.baseline, e.direction = n.direction, "letterSpacing" in e && (e.letterSpacing = `${n.letterSpacing * r}px`);
}
function Xt(e, t) {
	let n = t.fontSize * en(t.fontScale, 1), r = e.actualBoundingBoxLeft, i = e.actualBoundingBoxRight, a = e.actualBoundingBoxAscent, o = e.actualBoundingBoxDescent;
	if ([
		r,
		i,
		a,
...
var tn = {
	...
	group: () => [],
	navigation: () => []
}, nn = sn("x", !0), rn = sn("y", !0), an = sn("x", !1), on = sn("y", !1);
function sn(e, t) {
	...
	return {
		resolve(a, o) {
			...
			if (!d) return [];
			let p = cn(a, d, r), m = e === "x" ? c : s, h = p.reduce((e, t) => Math.abs(i(t) - m) < Math.abs(i(e) - m) ? t : e, d);
...
function ln(e) {
	if (e !== !1) {
		...
		switch (e) {
			case "nearest-x": return an;
			case "nearest-y": return on;
			case "group-x": return nn;
			case "group-y": return rn;
			case "nearest": return;
		}
	}
}
function un(e, t, n, r, i, a = e.points) {
	let o = ln(t);
	if (o) {
		if (a === e.points && (o === an || o === on || o === nn || o === rn)) {
			let t = Fe(e, n, r);
...
function fn(e, t) {
	...
	return n.find((e) => e.markId === t.markId && Object.is(e.group, t.group) && _n(e.xValue, t.xValue) && _n(e.yValue, t.yValue)) ?? n.find((e) => e.markId === t.markId && e.datumIndex === t.datumIndex) ?? n[0] ?? null;
}
function pn(e, t, n) {
	let r = t ? e.findIndex((e) => dn(e, t)) : -1, i;
	switch (n) {
		case "ArrowRight":
		case "ArrowDown":
...
function mn(e, t, n) {
	...
	let i = t ? e.findIndex((e) => dn(e, t)) : -1;
	if (!t || i < 0 || r === 0 || r === 2) return hn(e, r === 2);
	let a = null, o = -1;
	for (let n = 0; n < e.length; n += 1) {
		let s = e[n];
		if (!s) continue;
		let c = gn(s, n, t, i);
		r > 0 && c <= 0 || r < 0 && c >= 0 || (!a || r * gn(s, n, a, o) < 0) && (a = s, o = n);
	}
	return a ?? t;
}
function hn(e, t) {
...
function yn(e, t, n = Gt()) {
	Cn(t.definition.tooltip);
	let r = t, i, a, o = null, s = "pointer", c = null, l = null, u = null, d, f, p = !1, m, h = !1, g = !1, _, v, y = !1, b = !1, x, S, C = !1, w, T = /* @__PURE__ */ new Map(), E, D, O, k, A, j, M = null, ee = !1, N = e.style.position, P = e.ownerDocument.defaultView, te = P?.getComputedStyle(e).position, ne = !te || te === "static", F = Jt(e), re = e.ownerDocument.fonts;
	ne && (e.style.position = "relative");
	let I = (t = !1, n = "update") => {
		if (h) return;
		t && !r.measureText && F.refresh();
		let d = o, f = M, p = A;
		i = xn(Te()), a = i, _ ? _.renderer !== r.renderer && (v?.(), v = void 0, G(), De(), _.destroy(), e.replaceChildren(), _ = r.renderer.mount(e, oe), ke(), g = !1) : (_ = r.renderer.mount(e, oe), ke()), y = !0;
		try {
			_.render(i, {
				ariaLabel: r.ariaLabel,
				ariaDescription: r.ariaDescription,
				className: r.className,
				tabIndex: qt(r.definition, r.tabIndex),
				idPrefix: r.idPrefix,
				animation: g ? Dn(r.definition.svgAnimation, e, n) : void 0
			});
		} finally {
			y = !1;
		}
		...
		if (p ||= e, m = m === "layout" || t === "layout" ? "layout" : "resize", f === void 0) {
			if (!P?.requestAnimationFrame) {
				let e = ie(), t = p || e !== void 0 && e !== i.width;
				p = !1;
				let n = m ?? "layout";
				m = void 0, t && I(!0, n);
				return;
		...
		h || r.measureText || (F.invalidate(), oe(!0));
	}, L = () => r.definition.cursor, ce = () => E?.getState()?.pinned === !0, R = () => u !== null || ce(), le = () => {
		let e = L();
		e && (ee = !0);
		let t = e?.controller, n = e?.mode, r = e?.mode === "focus" ? e.match ?? "xy" : void 0;
		(t !== E?.controller || n !== D || r !== O || e?.use !== k) && (j?.(), j = void 0, E?.destroy(), E = e ? vn(e) : void 0, D = n, O = r, k = e?.use, j = E?.subscribe(() => {
			!h && g && ue(!1);
		}));
	}, ue = (e) => {
		let t = L();
		...
		let c = o;
		if (t.mode === "focus") {
			let i = ln(r.definition.focus), l = n.resolveFocus(H(), t, a, i), d = l[0] ?? null;
			a && (s = a.source), u = a?.pinned && d ? d.key : null, o = d, B(d, l), (!dn(c, d) || e && (c !== null || d !== null)) && (r.onFocusChange?.(d), r.onFocusGroupChange?.(l));
			return;
		}
		...
		setControlledFocus(e, t = {}) {
			...
			let n, r;
			Sn(e) ? (n = e, r = e.point) : (n = null, r = e), s = t.source ?? (n === null ? "programmatic" : "pointer");
			let i = H(), a = fn(i, r);
			...
			let d = U(a, i);
			if (u = t.pinned && (K() || L()?.pin === !0) ? a.key : null, dn(a, o)) {
				o = a, B(a, d);
				return;
			}
			z(d);
		...
		if (ce()) return !0;
		let r = ge(e, t);
		if (!r || !En(i, r)) return l = null, E?.clearOwnedTransient(), !0;
		let a = E;
		...
		r.definition.pointer === !1 || R() || (c = "pointer", s = "pointer", !_e(e.clientX, e.clientY) && z(me(e.clientX, e.clientY), Pe()));
	}, ye = (e) => {
		r.definition.pointer === !1 || R() || (c = "pointer", s = "pointer", _e(e.clientX, e.clientY));
	}, be = ({ relatedTarget: t }) => {
		r.definition.pointer !== !1 && c === "pointer" && !R() && !(P && t instanceof P.Node && e.contains(t)) && (l = null, L() ? E?.clearOwnedTransient() : z([]), c = null);
	}, xe = ({ relatedTarget: t }) => {
		c === "keyboard" && !u && !(P && t instanceof P.Node && e.contains(t)) && (l = null, L() ? E?.clearOwnedTransient() : z([]), c = null);
	}, Se = (t) => {
		...
		let i = Tn(r.definition.focus), a = i ? pn(i.navigation(n), o, e.key) : mn(n, o, e.key);
		...
		if (r.definition.keyboard !== !1 && L()?.mode !== "free" && e.target === _?.element && !o) {
			let e = Tn(r.definition.focus), t = H(), n = e ? e.navigation(t)[0] : mn(t, null, "Home");
			l = null, c = "keyboard", s = "keyboard", z(n ? U(n) : []);
		}
	};
	return e.addEventListener("pointermove", ve), e.addEventListener("pointerdown", ye), e.addEventListener("pointercancel", be), e.addEventListener("mouseleave", be), e.addEventListener("click", Se), e.addEventListener("keydown", Ce), e.addEventListener("focusin", we), e.addEventListener("focusout", xe), re?.addEventListener?.("loadingdone", se), le(), I(), ae(), {
		interaction: he,
		update(e) {
			if (h) return;
			Cn(e.definition.tooltip);
			let t = e.measureText === void 0 && F.refresh(), n = r.definition !== e.definition, i = r.height !== e.height || r.aspectRatio !== e.aspectRatio || r.width !== e.width || r.initialWidth !== e.initialWidth, a = r.idPrefix !== e.idPrefix || r.renderer !== e.renderer || r.measureText !== e.measureText || t, s = n || i || r.ariaLabel !== e.ariaLabel || r.ariaDescription !== e.ariaDescription || r.className !== e.className || r.tabIndex !== e.tabIndex || r.idPrefix !== e.idPrefix || r.renderer !== e.renderer || r.measureText !== e.measureText || t, d = r.width !== e.width, f = r.definition.pointer !== !1 && e.definition.pointer === !1 && c === "pointer";
			r = e, le(), Me(), f && (l = null, u = null, c = null, z([])), K() || (u = null), s ? I(!1, a ? "layout" : i ? "resize" : "update") : L() ? ue(!1) : o && B(o, U(o)), d && ae();
		},
		getScene: () => i,
		destroy() {
			h || (h = !0, d?.disconnect(), j?.(), j = void 0, E?.destroy(), E = void 0, D = void 0, O = void 0, k = void 0, re?.removeEventListener?.("loadingdone", se), f !== void 0 && P?.cancelAnimationFrame?.(f), G(), De(), v?.(), v = void 0, _?.destroy(), n.destroy(), e.removeEventListener("pointermove", ve), e.removeEventListener("pointerdown", ye), e.removeEventListener("pointercancel", be), e.removeEventListener("mouseleave", be), e.removeEventListener("click", Se), e.removeEventListener("keydown", Ce), e.removeEventListener("focusin", we), e.removeEventListener("focusout", xe), e.replaceChildren(), ne && e.style.position === "relative" && (e.style.position = N));
		}
	};
	function Te() {
		let e = ie() ?? r.initialWidth ?? 640;
		return n.render(r.definition, {
			width: e,
			height: r.height ?? (wn(r.aspectRatio) ? e / r.aspectRatio : 320)
		}, {
			measureText: r.measureText ?? F.measureText,
	...
	function V(e, t, n) {
		let o = H(), s = Tn(r.definition.focus), c = un(a, s, e, t, n, o);
		if (c) return c;
		let l = _?.getPresentationPoints?.() === void 0 ? w && a === i ? w.findNearest(e, t, n) : mt(a, e, t, n, o) : Ne(o, e, t, n), u = l ? fn(o, l) : null;
		return u ? [u] : [];
	}
	function H() {
	...
	function U(e, t = H()) {
		return Tn(r.definition.focus)?.group(t, { point: e }) ?? [e];
	}
	function ke() {
	...
	function W(t, n) {
		let a = Cn(r.definition.tooltip);
		if (!a || !t || !_) {
			S?.hide();
			return;
		}
		(x !== a.extension || !S) && (G(), x = a.extension, S = a.extension.create({
			container: e,
			dismiss: fe,
	...
	function Me() {
		let e = Cn(r.definition.tooltip);
		e ? e.extension === x ? S?.update(e.options) : G() : (S?.update(bn), S?.hide());
	}
	function G() {
	...
	function Pe() {
		let e = Cn(r.definition.tooltip)?.options.anchor;
...
function kn(e, t, n) {
	...
	let o = [];
	return jn(a, i, n ? o : void 0), n ? Fn(e, o, n) : () => {};
}
function An(e, t, n) {
	let r = e.ownerDocument.createElement("template");
	...
	let a = [];
	return jn(e, i, n ? a : void 0), n ? Fn(e, a, n) : () => {};
}
function jn(e, t, n) {
	if (Mn(e, t, n), !t.firstElementChild) {
		if (e.firstElementChild) for (let t of [...e.children]) n ? Pn(t, n) : t.remove();
		else e.textContent !== t.textContent && (e.textContent = t.textContent);
		return;
	}
	let r = [...e.children], i = [...t.children], a = zn(r), o = Bn(i), s = /* @__PURE__ */ new Set(), c = e.firstElementChild;
	i.forEach((t, r) => {
		let i = o[r], l = a.get(i), u;
		l && l.namespaceURI === t.namespaceURI && l.localName === t.localName ? (u = l, s.add(l), u !== c && e.insertBefore(u, c), jn(u, t, n)) : (u = t.cloneNode(!0), e.insertBefore(u, c), Nn(u, t, n)), c = u.nextElementSibling;
	});
	for (let t of r) !s.has(t) && t.parentElement === e && (n ? Pn(t, n) : t.remove());
}
function Mn(e, t, n) {
	...
	for (let i of r) {
		...
		if (r === a) continue;
		let o = n && a !== null && r !== null && On.has(i) ? Ln(a, r) : void 0;
		o && n ? n.push({
			element: e,
			name: i,
			interpolate: o,
...
function Fn(e, t, n) {
	...
	if (!i || !a || o === 0) return In(t), () => {};
	let s = 0, c = !1, l, u = Vn(n.easing ?? "ease-out"), d = (e) => {
		if (c) return;
		l ??= e;
...
function Un(e, t, n) {
	let r = t.idPrefix ?? "", i = t.className ? `ts-chart ${t.className}` : "ts-chart", a = t.ariaDescription ? `<desc>${er(t.ariaDescription)}</desc>` : "", o = n?.renderDefinitions?.(e, r) ?? "", s = e.theme.background === "transparent" ? "" : qn({
		kind: "rect",
		key: "background",
		x: 0,
		y: 0,
	...
	return `<svg class="${tr(i)}" width="100%" height="100%" viewBox="0 0 ${Q(e.width)} ${Q(e.height)}" role="img" aria-roledescription="chart" aria-label="${tr(t.ariaLabel)}" tabindex="${Q(t.tabIndex ?? 0)}" style="display:block;overflow:visible">${a}${o}${s}${Wn(e.nodes, r, n)}</svg>`;
}
function Wn(e, t = "", n) {
	return e.map((e) => qn(e, n, t)).join("");
}
function Gn(e, t, n = "", r) {
	return `<g data-ts-key="focus-guide-layer:${t}" class="ts-chart__focus-guide-layer ts-chart__focus-guide-layer--${t}" data-ts-focus-layer="${t}" data-ts-focus-guide-layer="${t}" aria-hidden="true" visibility="${e.length ? "visible" : "hidden"}">${Wn(e, n, r ?? Kn)}</g>`;
}
var Kn = { renderGroup: Xn };
function qn(e, t, n) {
	let r = Qn(e, t, n);
	switch (e.kind) {
		case "group": {
			let i = e.translateX === void 0 && e.translateY === void 0 ? "" : ` transform="translate(${Q(e.translateX ?? 0)} ${Q(e.translateY ?? 0)})"`, a = t?.renderGroup?.(e, n);
			return `<g${r}${i}${e.focus ? ` data-ts-focus-layer="${e.focus.placement}"${e.focus.retarget ? " data-ts-focus-retarget=\"true\"" : ""} visibility="hidden"` : ""}${a?.attributes ?? ""}>${a?.content ?? ""}${e.children.map((e) => qn(e, t, n)).join("")}</g>`;
		}
		case "rule": return `<line${r} x1="${Q(e.x1)}" y1="${Q(e.y1)}" x2="${Q(e.x2)}" y2="${Q(e.y2)}"/>`;
		case "polyline": return `<path${r} d="${e.path ?? e.points.map(([e, t], n) => `${n === 0 ? "M" : "L"}${Q(e)},${Q(t)}`).join("")}" vector-effect="non-scaling-stroke"/>`;
		case "area": return `<path${r} d="${e.polygons === void 0 ? e.path ?? Yn(e.points, !0) : Jn(e.polygons)}"${e.polygons === void 0 ? "" : " fill-rule=\"evenodd\""} vector-effect="non-scaling-stroke"/>`;
		case "dot": return `<circle${r} cx="${Q(e.x)}" cy="${Q(e.y)}" r="${Q(e.radius)}"/>`;
		case "rect": return `<rect${r} x="${Q(e.x)}" y="${Q(e.y)}" width="${Q(e.width)}" height="${Q(e.height)}"${e.radius === void 0 ? "" : ` rx="${Q(e.radius)}"`}/>`;
		case "label": {
			let t = e.rotate === void 0 ? "" : ` transform="rotate(${Q(e.rotate)} ${Q(e.x)} ${Q(e.y)})"`, n = e.anchor ? ` text-anchor="${e.anchor}"` : "", i = e.baseline ? ` dominant-baseline="${e.baseline}"` : "", a = e.fontSize === void 0 ? "" : ` font-size="${Q(e.fontSize)}"`, o = e.fontWeight === void 0 ? "" : ` font-weight="${Q(e.fontWeight)}"`;
			return `<text${r} x="${Q(e.x)}" y="${Q(e.y)}"${n}${i}${t}${a}${o} font-family="inherit">${er(e.text)}</text>`;
		}
	}
}
function Jn(e) {
	return e.flatMap((e) => e).filter((e) => e.length > 0).map((e) => Yn(e, !0)).join("");
}
function Yn(e, t) {
	return `${e.map(([e, t], n) => `${n === 0 ? "M" : "L"}${Q(e)},${Q(t)}`).join("")}${t ? "Z" : ""}`;
}
function Xn(e, t) {
	if (!e.clip) return;
	let n = t.replaceAll(/[^a-zA-Z0-9_-]/g, ""), r = `${n ? `${n}-` : ""}ts-chart-clip-${Zn(e.key)}`;
	return {
		attributes: ` clip-path="url(#${r})"`,
		content: `<defs data-ts-key="${tr(`${e.key}:clip-defs`)}"><clipPath id="${r}"><rect x="${Q(e.clip.x)}" y="${Q(e.clip.y)}" width="${Q(e.clip.width)}" height="${Q(e.clip.height)}"/></clipPath></defs>`
	};
}
function Zn(e) {
	let t = 2166136261;
...
function Qn(e, t, n) {
	return `${` data-ts-key="${tr(e.key)}"`}${e.className ? ` class="${tr(e.className)}"` : ""}${e.ariaHidden ? " aria-hidden=\"true\"" : ""}${$n(e.style, t, n)}`;
}
function $n(e, t, n) {
	if (!e) return "";
	...
	].filter((e) => e[1] != null).map(([e, t]) => ` ${e}="${typeof t == "number" ? Q(t) : tr(t)}"`).join("");
}
function Q(e) {
		...
		mount(n) {
			...
			return {
				...
				render(t, d) {
					...
					r = kn(n, e(t, d), f ? void 0 : d.animation), p && Gr(u(), m, (e) => t.focusGuides?.some((t) => t.placement === e) === !0), a = t, o = d, s = void 0, c = !1, l = !1;
				},
				clientToScene(e, t, n) {
					return oi(u(), e, t, n);
				},
				paintFocus(t, d, f) {
					...
					if (m.scene !== a || c || l || h) {
						i(), i = () => {};
						let t = Wr(u());
						r(), r = kn(n, e(m.scene, o), ai(p.transition ?? h, n)), Gr(u(), t);
					}
...
function li(e, t, n, r, i, a, o) {
	...
	for (let n of ["under", "over"]) {
		...
		let l = o === nr ? Gn(i, n, a.idPrefix ?? "") : Pr(e, t, i, n, a, o);
		c.push(An(r, l));
	}
...
function fi(e, t = {}) {
	...
	return te(({ markIndex: e }) => {
		let r = t.id ?? `bar-y-${e}`, i = I(n, t.x, (e, { index: t }) => t), a = _i(n, t.y ?? t.y2, (e) => typeof e == "number" ? e : void 0), o = I(n, t.z, () => null), s = t.color === void 0 ? o : I(n, t.color, () => null), c = t.z === void 0 && t.color !== void 0 ? s : o, l = t.y1 !== void 0 || t.y2 !== void 0;
		if (l && t.layout?.type === "stack") throw TypeError("A bar with explicit y1 or y2 endpoints cannot also configure a stack layout");
		let u = t.layout?.type === "group", d = t.layout?.type === "stack" ? t.layout : {}, f = !l && !u ? ue(i, a, c, d, "index") : void 0, p = l ? _i(n, t.y1, () => 0) : f?.starts ?? n.map(() => 0), m = l ? _i(n, t.y2 ?? t.y, () => void 0) : u ? a : f.ends, h = hi(i), g = u || !l && h ? c : o, _ = ie(n, t.key, {
			groups: g,
			candidates: [i],
			markId: r,
			warningIdentity: t
		...
		return {
			...
			render: ({ scales: e, chart: o, color: c }) => {
				...
				return n.forEach((o, v) => {
					...
					if (!N(y) || !P(b) || !P(x) || !P(S)) return;
					let C = g[v] ?? null, w = u?.map(C) ?? 0, T = c(s[v]), E = re(t.fill, o, v, n, T), D = e.x.map(y), O = e.y.map(x), k = e.y.map(S), A = D - l / 2 + w + f.inset, j = Math.min(O, k), ee = f.size, te = Math.abs(O - k), ne = `${r}:${M(C)}:${M(_[v])}`, F = {
						key: ne,
						markId: r,
						group: C,
...
function _i(e, t, n) {
	return typeof t == "number" ? e.map(() => t) : I(e, t, n);
}
//#endregion
