...
var y = () => 1;
function b(e, t, n, r) {
	return ee(e, String(t), n || y, r || function(t) {
		return e.outEdges(t) ?? [];
	});
}
function ee(e, t, n, r) {
...
function re(e, t, n, r) {
	let i = {}, a = new x(), o, s, c = function(e) {
...
function le(e) {
	...
	function i(a) {
		var o;
		if (a in n) throw new w();
		a in t || (n[a] = !0, t[a] = !0, (o = e.predecessors(a)) == null || o.forEach(i), delete n[a], r.push(a));
	}
	if (e.sinks().forEach(i), Object.keys(t).length !== e.nodeCount()) throw new w();
	return r;
}
function ue(e) {
	try {
...
function he(e, t) {
	...
	let l = e.nodes()[0];
	l !== void 0 && a.decrease(l, 0);
	let u = !1;
	for (; a.size() > 0;) {
		if (o = a.removeMin(), o in i) r.setEdge(o, i[o]);
		else {
			if (u) throw Error("Input graph is not connected: " + e);
			u = !0;
		}
...
function ge(e, t, n, r) {
	return _e(e, t, n, r ?? ((t) => e.outEdges(t) ?? []));
}
function _e(e, t, n, r) {
	if (n === void 0) return S(e, t, n, r);
	let i = !1, a = e.nodes();
...
function ye(e) {
	let t = new E({ multigraph: e.isMultigraph() }).setGraph(e.graph());
...
function xe(e) {
	let t = e.nodes().map((t) => e.node(t).rank).filter((e) => e !== void 0), n = A(Math.min, t), r = [];
	e.nodes().forEach((t) => {
...
function Se(e, t, n, r) {
	...
	return arguments.length >= 4 && (i.rank = n, i.order = r), D(e, "border", i, t);
}
function Ce(e, t = we) {
	let n = [];
...
var we = 65535;
function A(e, t) {
	return t.length > we ? e(...Ce(t).map((t) => e(...t))) : e(...t);
}
function j(e) {
	let t = e.nodes().map((t) => {
		let n = e.node(t).rank;
...
var Ae = class {
	...
	dequeue() {
		...
		if (t !== e) return je(t), t;
	}
	enqueue(e) {
		let t = this._sentinel;
		e._prev && e._next && je(e), e._next = t._next, t._next._prev = e, t._next = e, e._prev = t;
	}
	toString() {
		let e = [], t = this._sentinel, n = t._prev;
		for (; n !== t;) e.push(JSON.stringify(n, Me)), n = n._prev;
		return "[" + e.join(", ") + "]";
	}
};
function je(e) {
...
function Le(e, t) {
	...
	let a = Re(i + r + 3).map(() => new Ne()), o = r + 1;
...
function ze(e, t) {
	(e.graph().acyclicer === "greedy" ? Fe(e, n(e)) : Be(e, t ?? null)).forEach((t) => {
		let n = e.edge(t);
		e.removeEdge(t), n.forwardName = t.name, n.reversed = !0, e.setEdge(t.w, t.v, n, M("rev"));
	});
	function n(e) {
...
function Be(e, t) {
	...
	function o(a) {
		...
		Object.hasOwn(i, a) || (i[a] = !0, r[a] = !0, (s = e.outEdges(a)) == null || s.forEach((i) => {
			Object.hasOwn(r, i.w) || t.node(a)?.rank > t.node(i.w)?.rank && He(e, i.w, i) ? n.push(i) : o(i.w);
		}), delete r[a]);
	}
	let s = a;
...
function Ue(e) {
	e.graph().dummyChains = [], e.edges().forEach((t) => We(e, t));
}
function We(e, t) {
	...
	for (d = 0, ++r; r < a; ++d, ++r) s.points = [], u = {
		...
		edgeObj: t,
		rank: r
	}, l = D(e, "edge", u, "_d"), r === c && (u.width = s.width, u.height = s.height, u.dummy = "edge-label", u.labelpos = s.labelpos), e.setEdge(n, l, { weight: s.weight }, o), d === 0 && e.graph().dummyChains.push(l), n = l;
...
function z(e) {
	...
	function n(r) {
		...
		t[r] = !0;
		let a = e.outEdges(r), o = a ? a.map((t) => t == null ? Infinity : n(t.w) - e.edge(t).minlen) : [], s = A(Math.min, o);
...
var V = Ke;
function Ke(e) {
	let t = new E({ directed: !1 }), n = e.nodes();
	if (n.length === 0) throw Error("Graph must have at least one node");
	let r = n[0], i = e.nodeCount();
	t.setNode(r, {});
	let a, o;
	for (; qe(t, e) < i && (a = Je(t, e), a);) o = t.hasNode(a.v) ? B(e, a) : -B(e, a), Ye(t, e, o);
	return t;
}
function qe(e, t) {
	function n(r) {
		...
		i && i.forEach((i) => {
			...
			!e.hasNode(o) && !B(t, i) && (e.setNode(o, {}), e.setEdge(r, o, {}), n(o));
		});
	}
...
function Je(e, t) {
	return t.edges().reduce((n, r) => {
		let i = Infinity;
		return e.hasNode(r.v) !== e.hasNode(r.w) && (i = B(t, r)), i < n[0] ? [i, r] : n;
	}, [Infinity, null])[1];
}
function Ye(e, t, n) {
	e.nodes().forEach((e) => t.node(e).rank += n);
}
var { preorder: Xe, postorder: Ze } = v, Qe = H;
H.initLowLimValues = G, H.initCutValues = U, H.calcCutValue = W, H.leaveEdge = q, H.enterEdge = J, H.exchangeEdges = et;
function H(e) {
	e = ve(e), z(e);
	let t = V(e);
	G(t), U(t, e);
	let n, r;
	for (; n = q(t);) r = J(t, e, n), et(t, e, n, r);
}
function U(e, t) {
	let n = Ze(e, e.nodes());
	n = n.slice(0, n.length - 1), n.forEach((n) => $e(e, t, n));
}
function $e(e, t, n) {
...
function K(e, t, n, r, i) {
	...
	return s && s.forEach((i) => {
		Object.hasOwn(t, i) || (n = K(e, t, n, i, r));
...
function J(e, t, n) {
	...
	return a.lim > o.lim && (s = o, c = !0), t.edges().filter((t) => c === rt(e, e.node(t.v), s) && c !== rt(e, e.node(t.w), s)).reduce((e, n) => B(t, n) < B(t, e) ? n : e);
}
function et(e, t, n, r) {
	let i = n.v, a = n.w;
	e.removeEdge(i, a), e.setEdge(r.v, r.w, {}), G(e), U(e, t), tt(e, t);
}
function tt(e, t) {
...
var ct = lt;
function lt(e) {
	let t = dt(e), n = e.graph();
	Array.isArray(n.dummyChains) && n.dummyChains.forEach((n) => {
		let r = e.node(n), i = r.edgeObj, a = ut(e, t, i.v, i.w), o = a.path, s = a.lca, c = 0, l = o[c], u = !0;
		for (; n !== i.w;) {
			if (r = e.node(n), u) {
...
function dt(e) {
	...
	return e.children(I).forEach(r), t;
}
function ft(e) {
	let t = D(e, "root", {}, "_root"), n = mt(e), r = Object.values(n), i = A(Math.max, r) - 1, a = 2 * i + 1;
...
function pt(e, t, n, r, i, a, o) {
	...
	let c = Se(e, "_bt"), l = Se(e, "_bb"), u = e.node(o);
...
function mt(e) {
	...
	return e.children(I).forEach((e) => n(e, 1)), t;
}
function ht(e) {
...
function Et(e, t = null) {
	let n = {}, r = e.nodes().filter((t) => !e.children(t).length), i = r.map((t) => e.node(t).rank), a = N(A(Math.max, i) + 1).map(() => []);
	function o(t) {
		if (n[t]) return;
		n[t] = !0;
		let r = e.node(t);
...
function Ot(e, t, n) {
	let r = Oe(n, n.map((e, t) => t)), i = t.flatMap((t) => {
		let n = e.outEdges(t);
		return n ? n.map((t) => ({
			pos: r[t.w],
...
function At(e, t) {
	...
	}), jt(Object.values(n).filter((e) => !e.indegree));
}
function jt(e) {
	let t = [];
	function n(e) {
		return (t) => {
			t.merged || (t.barycenter === void 0 || e.barycenter === void 0 || t.barycenter >= e.barycenter) && Mt(e, t);
		};
	}
	function r(t) {
		return (n) => {
	...
	return t.filter((e) => !e.merged).map((e) => P(e, [
		"vs",
		"i",
		"barycenter",
		"weight"
...
function Nt(e, t, n, r, i) {
	...
	let l = Te(e, (e) => Object.hasOwn(e, "barycenter")), u = l.lhs, d = l.rhs.sort((e, t) => t.i - e.i), f = [], p = 0, m = 0, h = 0;
	u.sort(Ft(s, o, !!c));
	for (let [e, t] of Object.entries(a)) {
		let n = u.findIndex((t) => t.vs[0] === e);
		u.splice(n + 1, 0, t);
	}
	h = Pt(f, d, h), u.forEach((e) => {
		h += e.vs.length, f.push(e.vs), p += e.barycenter * e.weight, m += e.weight, h = Pt(f, d, h);
	});
	let g = { vs: f.flat(1) };
...
function Ft(e, t, n) {
	return (r, i) => {
		...
		if (e && (typeof r.vs[0] == "string" || typeof i.vs[0] == "string")) {
			let n = ke(t, e.node(r.vs[0]), e.node(i.vs[0]));
			if (n !== 0) return n;
		}
...
function It(e, t, n, r, i) {
	...
	m.forEach((t) => {
		if (e.children(t.v).length) {
			let { result: r } = It(e, t.v, n, s, c);
			p[t.v] = r, Object.hasOwn(r, "barycenter") && Rt(t, r);
		}
	});
	let h = At(m, n);
	Lt(h, p);
...
function zt(e, t, n, r) {
	r ||= e.nodes();
	let i = Bt(e), a = new E({ compound: !0 }).setGraph({ root: i }).setDefaultNodeLabel((t) => e.node(t));
	return r.forEach((r) => {
...
function Ht(e, t = {}, n = null) {
	...
	let r = j(e), i = Ut(e, N(1, r + 1), "inEdges"), a = Ut(e, N(r - 1, -1, -1), "outEdges"), o = Et(e, n);
	if (Gt(e, o), t.disableOptimalOrderHeuristic) return;
	let s = Infinity, c, l = t.constraints || [];
	for (let t = 0, r = 0; r < 4; ++t, ++r) {
		Wt(t % 2 ? i : a, t % 4 >= 2, l, n), o = k(e);
		let u = Dt(e, o);
...
function Wt(e, t, n, r) {
	...
	e.forEach(function(e) {
		...
		let o = e.graph().root, { result: s, usedBias: c } = It(e, o, a, r, i);
		t && c && (i = !i), s.vs.forEach((t, n) => e.node(t).order = n), Vt(e, a, s.vs);
	});
}
function Gt(e, t) {
...
function Zt(e, t, n, r, i) {
	...
	return t.forEach((e) => {
		...
		let c = -1, l = -1, u = !1, d = t, f = t.findIndex((t) => i?.includes(t) || sn(t, e, i));
		f > 0 && (d = [
			t[f],
			...t.slice(0, f),
			...t.slice(f + 1)
			...
			let d = r(t);
			if (d && d.length) {
				i != null && i.includes(t) && (d = d.filter((t) => sn(t, e, i)));
				let r = d.sort((e, t) => {
					let n = s[e], r = s[t];
				...
				for (let e = Math.floor(f), i = Math.ceil(f); e <= i; ++e) {
					...
					let d = s[i];
					if (d !== void 0 && o[t] === t && c < d && s[i] !== l && !Xt(n, t, i)) {
						let e = a[i];
...
function Qt(e, t, n, r, i = !1) {
	let a = {}, o = $t(e, t, n, i), s = i ? "borderLeft" : "borderRight";
	function c(e, t) {
...
function $t(e, t, n, r) {
	let i = new E(), a = e.graph(), o = an(a.nodesep, a.edgesep, r);
	return t.forEach((t) => {
		let r;
		t.forEach((t) => {
			let a = n[t];
...
function tn(e, t) {
	let n = Object.values(t), r = A(Math.min, n), i = A(Math.max, n);
	["u", "d"].forEach((n) => {
		["l", "r"].forEach((a) => {
			let o = n + a, s = e[o];
			if (!s || s === t) return;
			let c = Object.values(s), l = r - A(Math.min, c);
			a !== "l" && (l = i - A(Math.max, c)), l && (e[o] = F(s, (e) => e + l));
		});
	});
}
...
function rn(e, t) {
	let n = k(e), r = Object.assign(Kt(e, n), qt(e, n)), i = {}, a;
	return ["u", "d"].forEach((o) => {
		a = o === "u" ? n : Object.values(n).reverse(), ["l", "r"].forEach((n) => {
			n === "r" && (a = a.map((e) => Object.values(e).reverse()));
			let s = Zt(e, a, r, (t) => (o === "u" ? e.predecessors(t) : e.successors(t)) || [], t), c = Qt(e, a, s.root, s.align, n === "r");
			n === "r" && (c = F(c, (e) => -e)), i[o + n] = c;
		});
	}), tn(i, en(e, i)), nn(i, e.graph().align);
}
function an(e, t, n) {
	return (r, i, a) => {
...
function cn(e, t) {
	e = ye(e), ln(e), Object.entries(rn(e, t)).forEach(([t, n]) => e.node(t).x = n);
}
function ln(e) {
	let t = k(e), n = e.graph(), r = n.ranksep, i = n.rankalign, a = 0;
	t.forEach((t) => {
		let n = t.reduce((t, n) => {
...
function pn(e, t, n) {
	...
	let h = wn(e), g = mn(h, t, n, un.get(e) ?? null);
	un.set(e, g), hn(e, h), m.forEach((t) => {
...
function mn(e, t, n, r = null) {
	...
	t("    makeSpaceForEdgeLabels", () => Tn(e)), t("    removeSelfEdges", () => Pn(e)), t("    acyclic", () => ze(e, s)), t("    nestingGraph.run", () => ft(e)), t("    rank", () => it(ye(e))), t("    injectEdgeLabelProxies", () => En(e)), t("    removeEmptyRanks", () => xe(e)), t("    nestingGraph.cleanup", () => gt(e)), t("    normalizeRanks", () => be(e)), t("    assignRankMinMax", () => Dn(e)), t("    removeEdgeLabelProxies", () => On(e)), t("    normalize.run", () => Ue(e)), t("    parentDummyChains", () => ct(e)), t("    addBorderSegments", () => _t(e)), t("    order", () => Ht(e, n, c)), t("    insertSelfEdges", () => Fn(e)), t("    adjustCoordinateSystem", () => bt(e)), t("    position", () => cn(e, n.corePath)), t("    positionSelfEdges", () => In(e));
	let l = JSON.parse(JSON.stringify(e._nodes));
	return t("    removeBorderNodes", () => Nn(e)), t("    normalize.undo", () => Ge(e)), t("    fixupEdgeLabelCoords", () => jn(e)), t("    undoCoordinateSystem", () => xt(e)), t("    translateGraph", () => kn(e)), t("    assignNodeIntersects", () => An(e)), t("    reversePoints", () => Mn(e)), t("    acyclic.undo", () => Ve(e)), {
		graph: e,
		rawNodes: l
	};
}
...
function wn(e) {
	...
	return t.setGraph(Object.assign({}, _n, Q(n, gn), P(n, vn))), e.nodes().forEach((n) => {
		let r = Q($(e.node(n)), yn);
		...
		let r = $(e.edge(n));
		t.setEdge(n, Object.assign({}, Sn, Q(r, xn), P(r, Cn)));
	}), t;
}
function Tn(e) {
	let t = e.graph();
...
function An(e) {
	e.edges().forEach((t) => {
		...
		n.points ? (a = n.points[0], o = n.points[n.points.length - 1]) : (n.points = [], a = i, o = r), n.points.unshift(O(r, a)), n.points.push(O(i, o));
	});
}
function jn(e) {
	e.edges().forEach((t) => {
...
var Ln = 160, Rn = 50, zn = 8, Bn = 24, Vn = 6, Hn = {
	external: {
		fill: "#f0f0f0",
		stroke: "#b0b0b0"
	},
...
}, Un = "#c0c0c0", Wn = "dpuse-tool-d3-erd-arrow";
function Gn(t, n, r = {}) {
	let i = r.nodeWidth ?? Ln, o = r.nodeHeight ?? Rn, s = r.padding ?? zn, c = r.selfEdgeSize ?? Bn, l = r.cornerRadius ?? Vn, u = r.nodeColors ?? Hn, d = r.edgeColor ?? Un, f = r.orderConstraints ?? [];
	function p() {
		...
		_.append("defs").append("marker").attr("id", Wn).attr("viewBox", "0 0 10 10").attr("refX", 9).attr("refY", 5).attr("markerWidth", 6).attr("markerHeight", 6).attr("orient", "auto-start-reverse").append("path").attr("d", "M 0 0 L 10 5 L 0 10 z").attr("fill", d), v.append("g").attr("fill", "none").attr("stroke", d).attr("stroke-width", 1.25).selectAll("path").data(t.edges).join("path").attr("marker-end", `url(#${Wn})`).attr("d", (e) => e.source === e.target ? qn(r.node(e.source), c) : Kn(r.node(e.source), r.node(e.target), l));
		...
		y.append("rect").attr("width", (e) => r.node(e).width).attr("height", (e) => r.node(e).height).attr("rx", l).attr("fill", (e) => u[r.node(e).typeId].fill).attr("stroke", (e) => u[r.node(e).typeId].stroke).attr("stroke-dasharray", (e) => u[r.node(e).typeId].strokeDasharray ?? null), y.append("text").attr("x", (e) => r.node(e).width / 2).attr("y", (e) => r.node(e).height / 2).attr("text-anchor", "middle").attr("dominant-baseline", "middle").attr("font-family", "Helvetica, Arial, sans-serif").attr("font-size", 14).attr("fill", "#000000").text((e) => r.node(e).label ?? "");
		let b = _.node();
...
function Kn(e, t, n) {
	let r = e.x ?? 0, i = (e.y ?? 0) + e.height / 2, a = t.x ?? 0, o = (t.y ?? 0) - t.height / 2;
	if (r === a) return `M ${String(r)} ${String(i)} L ${String(a)} ${String(o)}`;
	let s = (i + o) / 2, c = Math.sign(a - r), l = Math.max(0, Math.min(n, s - i, o - s, Math.abs(a - r) / 2));
	return [
		`M ${String(r)} ${String(i)}`,
		`L ${String(r)} ${String(s - l)}`,
		`Q ${String(r)} ${String(s)} ${String(r + c * l)} ${String(s)}`,
		`L ${String(a - c * l)} ${String(s)}`,
		`Q ${String(a)} ${String(s)} ${String(a)} ${String(s + l)}`,
		`L ${String(a)} ${String(o)}`
	].join(" ");
}
function qn(e, t) {
...
//# sourceMappingURL=erdDiagram-Ds1hsQDD.js.map