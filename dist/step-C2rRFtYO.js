...
function u(e, t) {
	this._basis = new i(e), this._beta = t;
}
u.prototype = {
	lineStart: function() {
	...
	lineEnd: function() {
		switch (this._point) {
			case 2:
				...
				break;
			case 3: f(this, this._x1, this._y1);
		}
		(this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
	},
	point: function(e, t) {
...
function k(e, t, n) {
	...
	return (O(a) + O(o)) * Math.min(Math.abs(a), Math.abs(o), .5 * Math.abs(s)) || 0;
}
function A(e, t) {
	var n = e._x1 - e._x0;
	...
	lineEnd: function() {
		switch (this._point) {
			case 2:
				...
				break;
			case 3: j(this, this._t0, A(this, this._t0));
		}
		(this._line || this._line !== 0 && this._point === 1) && this._context.closePath(), this._line = 1 - this._line;
	},
	point: function(e, t) {
		...
		if (e = +e, t = +t, e !== this._x1 || t !== this._y1) {
			switch (this._point) {
				...
				case 1:
					...
					break;
				case 2:
					this._point = 3, j(this, A(this, n = k(this, e, t)), n);
					break;
				default: j(this, this._t0, n = k(this, e, t));
			}
...
(N.prototype = Object.create(M.prototype)).point = function(e, t) {
	M.prototype.point.call(this, t, e);
};
function P(e) {
	this._context = e;
}
...
L.prototype = {
	...
	lineEnd: function() {
		...
		if (n) {
			...
			else for (var r = R(e), i = R(t), a = 0, o = 1; o < n; ++a, ++o) this._context.bezierCurveTo(r[0][a], i[0][a], r[1][a], i[1][a], e[o], t[o]);
		}
...
//#endregion
export { a as _, F as a, T as c, v as d, g as f, s as g, l as h, z as i, C as l, d as m, H as n, I as o, m as p, V as r, D as s, U as t, x as u, t as v };
