...
import { t } from "./src-kLpf-6r0.js";
import { c as n, f as r, n as i, r as a, t as o } from "./select-BIuoFcZG.js";
import { s } from "./nodrag-Dq2tlBbe.js";
import { t as c } from "./drag-Ieen6R0z.js";
import { I as l, M as u, P as d, a as f, i as p, n as m, o as h, r as g, t as _ } from "./utcTime-DLfrQXna.js";
import { _ as v, a as y, c as b, d as x, f as S, g as C, h as w, i as T, l as E, m as D, n as ee, o as te, p as ne, r as re, s as ie, t as ae, u as oe, v as se } from "./step-C2rRFtYO.js";
...
var O = ce(), k = O?.document, [ue, de, fe, pe] = le(O), A = (e) => e || e === 0, j = (e) => typeof e == "function", M = (e) => typeof e == "string", N = (e) => typeof e == "number", P = (e) => e === void 0, F = (e) => e !== void 0, me = (e) => typeof e == "boolean", he = (e) => Math.ceil(e / 10) * 10, ge = (e) => Math.ceil(e) + .5, _e = (e) => e[1] - e[0], I = (e) => typeof e == "object", ve = (e) => {
	for (let t in e) if (Object.prototype.hasOwnProperty.call(e, t)) return !1;
	return !0;
}, ye = (e) => P(e) || e === null || M(e) && e.length === 0 || I(e) && !(e instanceof Date) && ve(e) || N(e) && isNaN(e), L = (e) => !ye(e), R = (e) => Array.isArray(e), z = (e) => e && !e?.nodeType && I(e) && !R(e), be = /* @__PURE__ */ new Set(/* @__PURE__ */ "span.div.p.br.b.i.em.small.strong.mark.u.s.sub.sup.h1.h2.h3.h4.h5.h6.ul.ol.li.dl.dt.dd.table.thead.tbody.tfoot.tr.th.td.caption.colgroup.col.hr.pre.code.blockquote.abbr.ins.del.a.img.figure.figcaption.svg.g.path.circle.ellipse.rect.line.polyline.polygon.text.tspan.textPath.use.defs.symbol.clipPath.mask.linearGradient.radialGradient.stop.pattern.marker.title.desc".split(".")), xe = /* @__PURE__ */ new Set(/* @__PURE__ */ "class.id.style.title.lang.dir.href.src.alt.width.height.colspan.rowspan.scope.headers.d.points.x.y.x1.x2.y1.y2.cx.cy.r.rx.ry.dx.dy.viewBox.preserveAspectRatio.transform.fill.fill-opacity.fill-rule.stroke.stroke-width.stroke-opacity.stroke-linecap.stroke-linejoin.stroke-dasharray.stroke-dashoffset.opacity.clip-path.clip-rule.mask.font-family.font-size.font-weight.font-style.text-anchor.dominant-baseline.offset.stop-color.stop-opacity.gradientUnits.gradientTransform.spreadMethod.patternUnits.patternTransform.marker-start.marker-mid.marker-end.markerWidth.markerHeight.refX.refY.xlink:href".split(".")), Se = /* @__PURE__ */ new Map();
be.forEach((e) => Se.set(e.toLowerCase(), e));
var Ce = /* @__PURE__ */ new Map();
xe.forEach((e) => Ce.set(e.toLowerCase(), e));
var we = /* @__PURE__ */ new Set([
	...
	"src",
	"xlink:href"
]), Ee = /^<\/?([a-zA-Z][a-zA-Z0-9]*)/, De = /^<\/([a-zA-Z][a-zA-Z0-9]*)\s*>$/, Oe = /^<([a-zA-Z][a-zA-Z0-9]*)([\s\S]*?)(\/?)>$/, ke = /([a-zA-Z][\w:-]*)\s*(?:=\s*(?:"([^"]*)"|'([^']*)'|([^\s>]+)))?/g, Ae = /url\s*\(\s*["']?([^"')]+)["']?\s*\)/gi, je = [
	"expression(",
	"behavior:",
	"binding:",
	"@import",
...
function Ne(e) {
	let t = Me(e).trim().replace(/[\s\u0000-\u001f]/g, "").toLowerCase();
	if (!t || t.startsWith("#")) return !0;
	let n = t.match(/^[^/?#]*:/);
	return !n || we.has(n[0]);
}
function Pe(e) {
	let t = Me(e).replace(/[\u0000-\u001f]/g, "");
	Ae.lastIndex = 0;
	let n;
	for (; (n = Ae.exec(t)) !== null;) if (!Ne(n[1])) return null;
	let r = t.toLowerCase().replace(/\s/g, "");
	for (let e of je) if (r.includes(e)) return null;
	return e;
}
var Fe = {
	"\"": "&quot;",
...
function Le(e) {
	return e.replace(Ie, (e) => Fe[e]);
}
function Re(e, t, n = !1) {
	if (Te.has(e)) return Ne(t) ? n ? Le(t) : t : null;
	if (e === "style") {
		let e = Pe(t);
		return e === null ? null : n ? Le(e) : e;
	}
	let r = Me(t).toLowerCase().replace(/\s/g, "");
	return /\bon\w+=/.test(r) ? null : n ? Le(t) : t;
}
function ze(e) {
	let t = e.match(Ee);
...
function Ve(e) {
	...
	let n = e.match(Oe);
	if (!n) return "";
	let [, r, i, a] = n, o = r.toLowerCase(), s = Se.get(o) ?? o, c = [];
	ke.lastIndex = 0;
	let l;
	for (; (l = ke.exec(i)) !== null;) {
		let e = l[1].toLowerCase(), t = l[2], n = l[3], r = l[4];
		if (e.startsWith("on")) continue;
		let i = Ce.get(e) ?? e, a, o;
		if (t !== void 0) a = t, o = "\"";
...
function He(e) {
	return typeof e != "string" || !e || e.indexOf("<") === -1 ? e : e.replace(/<\/?[^>]*>|[^<>\s]+>/g, (e) => e.startsWith("<!--") ? "" : e.startsWith("<") ? Be(e) ? Ve(e) : e.replace(/</g, "&lt;") : e.slice(0, -1) + "&gt;");
}
//#endregion
...
function $e(e, ...t) {
	...
	let n = t.shift();
	return z(e) && z(n) && Object.keys(n).forEach((t) => {
		if (!/^(__proto__|constructor|prototype)$/i.test(t)) {
			let r = n[t];
			r instanceof Date ? e[t] = new Date(r.getTime()) : z(r) ? (!e[t] && (e[t] = {}), e[t] = $e(e[t], r)) : e[t] = R(r) ? r.concat() : r;
		}
	}), $e(e, ...t);
}
function et(e, t = !0) {
...
function it(e, t, n, r, i) {
	...
	return i && (o = e[a].y, s = e[a].h), t >= o && t <= o + s ? a : t < o ? it(e, t, n, a - 1, i) : it(e, t, a + 1, r, i);
}
function at(e, t) {
	return He(e.replace(/\{=([^}]+)\}/g, (e, n) => t[n] ?? ""));
}
function ot(e) {
	let t;
...
}, pt = "https://github.com/naver/billboard.js/blob/master/MODULE_IMPORTS.md";
function mt(e) {
	let t = e, { config: n } = t, r = "";
	if (ye(n.data_type || n.data_types) && !t[dt.LINE]) r = "line";
	else for (let e in dt) {
		let n = H[e];
		if (t.hasType(n) && !t[dt[e]]) {
			r = n;
			break;
		}
	}
	r && ht(`Please, make sure if %c${qe(r)}`, "module has been imported and specified correctly.", pt);
}
function ht(e, t, n) {
	let r = "[billboard.js]";
	if (O.console?.error) {
		let i = t ? ["background:red;color:white;display:block;font-size:15px", t] : [];
		console.error(`❌ ${r} ${e}`, "background:red;color:white;display:block;font-size:15px", ...i), n && console.info("%cℹ️", "font-size:15px", n);
	}
...
//#endregion
//#region node_modules/billboard.js/dist-esm/module/util/dom.js
var _t = /\s?(bb-)/g, vt = /\.+/g;
function yt(e) {
	return e.replace(_t, ".$1").replace(vt, ".");
}
function bt(e, t, n = !1) {
...
function St(e) {
	let { x: t, y: n, width: r, height: i } = wt(e, !0);
	return [
		{
			x: t,
			y: n + i
...
function Tt(e, t, n) {
	let { rootSelector: r = "", sheet: i } = e, a = `${r} ${yt(t)} {${n.join(";")}}`;
...
var Pt = {
	...
	constructor() {
		return Ye(nn, $t, on, en, sn, tn, rn, an, e.data);
	}
}, ln = {
	element: class {
		constructor() {
...
}, { setTimeout: fn, clearTimeout: pn } = O;
function mn(e, t) {
	let n = [], r, i = null, a = function() {
		a.clear(), t && i === null && (i = ue(() => {
			i = null, t();
		})), r = e === !1 ? fe(() => {
			r = null, n.forEach((e) => e());
		}, { timeout: 200 }) : fn(() => {
			r = null, n.forEach((e) => e());
		}, N(e) ? e : 200);
	};
...
function hn() {
	...
	return t.add = function(t) {
		R(t) ? e = e.concat(t) : e.push(t);
	}, t;
}
//#endregion
//#region node_modules/billboard.js/dist-esm/module/worker.js
var gn = {}, _n = /* @__PURE__ */ new Set(), vn = /* @__PURE__ */ new Map(), yn = 5e3, bn = 3, xn = 0;
function Sn() {
	try {
...
function Cn() {
	let { Blob: e, Worker: t, URL: n } = O;
	return t && e && n?.createObjectURL && n?.revokeObjectURL ? {
		Blob: e,
		Worker: t,
		URL: n
	} : null;
...
function Tn(e) {
	return typeof e == "number" ? {
		...
		timeout: e?.timeout ?? yn,
		workerUrl: e?.workerUrl ?? ""
	};
}
function En(e, t = !1) {
	let n = gn[e];
	t && _n.add(e), n && (n.worker?.terminate(), n.revoke && Cn()?.URL.revokeObjectURL(n.src), delete gn[e]);
	for (let t of vn.keys()) t.startsWith(`${e}:`) && vn.delete(t);
}
function Dn(e, t) {
	if (e === t) return !0;
	try {
...
function On(e) {
	let [t, ...n] = e;
	return Array.isArray(t) ? [t.slice(0, bn).map((e) => Array.isArray(e) ? e.slice(0, 4) : e), ...n] : e;
}
function kn(e, t, n, r) {
	let i = ++xn, a = !1, o, s = new Promise((t, n) => {
		let s = (e, t) => {
			a || (a = !0, o(), e(t));
		}, c = function(e) {
			e.data?.id === i && (e.data.error ? s(n, Error(e.data.error)) : s(t, e.data.result));
		}, l = function() {
			s(n, /* @__PURE__ */ Error("worker error"));
		}, u = setTimeout(() => s(n, /* @__PURE__ */ Error("worker timeout")), r);
		o = () => {
			clearTimeout(u), e.removeEventListener("message", c), e.removeEventListener("error", l);
		}, e.addEventListener("message", c), e.addEventListener("error", l);
	});
	try {
		e.postMessage({
			args: n,
...
function An(e, t, n, r, i, a) {
	let o = On(i), s = kn(e, n, o, a).then((e) => Dn(e, r(...o)), () => !1).then((e) => (e ? vn.set(t, !0) : vn.delete(t), e));
	return vn.set(t, s), s;
}
function jn(e, t = "") {
	let n = !!wn(), r = t ? null : Cn(), i = t ? "" : Sn(), a = t || "blob";
	if (!n || !t && (!r || !i) || _n.has(a)) return null;
	if (!(a in gn)) try {
		if (t) gn[a] = {
			revoke: !1,
			src: t,
			...
			let e = new r.Blob([i], { type: "text/javascript" });
			gn[a] = {
				revoke: !0,
				src: r.URL.createObjectURL(e),
				worker: null
			};
		}
	} catch {
...
function Nn(e = !0, t, n, r, i) {
	let { timeout: a, workerUrl: o } = Tn(i), s = function(...e) {
		r(n(...e));
	}, c = s;
	if (e) {
		let e = jn(t, o), i = e ? Mn(e.key, e.src) : null;
		if (i && e) {
			let { key: o } = e;
			c = function(...e) {
				let l = () => {
				...
				try {
					let s = `${o}:${t}`, c = vn.get(s) ?? An(i, s, t, n, e, a);
					kn(i, t, e, a).then((e) => {
						c === !0 ? r(e) : c.then((t) => t ? r(e) : l());
					}, l);
				} catch {
					l();
				}
...
function Pn() {
	...
	for (let t in gn) {
		let n = gn[t];
		n.worker && n.worker.terminate(), n.src && n.revoke && e?.URL.revokeObjectURL(n.src), delete gn[t];
	}
	_n.clear(), vn.clear();
}
//#endregion
//#region node_modules/billboard.js/dist-esm/module/dsv.js
var Fn = 34, In = 10, Ln = 13;
function Rn(e) {
	let t = e.charCodeAt(0);
	function n(e, n) {
		let r = [], i = e.length, a = 0, o = 0, s = i <= 0, c = !1;
		e.charCodeAt(0) === 65279 && a++, e.charCodeAt(i - 1) === In && --i, e.charCodeAt(i - 1) === Ln && --i;
		function l() {
			if (s) return null;
			if (c) return c = !1, null;
			let n = a, r, o;
			if (e.charCodeAt(n) === Fn) {
				for (; ++a < i;) if (e.charCodeAt(a) === Fn) {
					if (e.charCodeAt(a + 1) !== Fn) break;
					a++;
				}
				return (o = a++) >= i ? s = !0 : (r = e.charCodeAt(a++)) === In ? c = !0 : r === Ln && (c = !0, e.charCodeAt(a) === In && ++a), e.slice(n + 1, o).replace(/""/g, "\"");
			}
			for (; a < i;) {
				if ((r = e.charCodeAt(o = a++)) === In) c = !0;
				else if (r === Ln) c = !0, e.charCodeAt(a) === In && ++a;
...
var zn = Rn(","), Bn = Rn("	"), Vn = zn.parse, Hn = zn.parseRows, Un = Bn.parse, Wn = Bn.parseRows;
//#endregion
...
function $n(e) {
	...
	if (R(t)) {
		let t = 0;
		for (let n = 0, r = e.length; n < r; n++) t += e[n]?.length ?? 0;
		return t;
	}
...
function tr(e, t, n) {
	...
	e.forEach((e) => {
		...
		}).filter((e) => e !== !1)) : i.data_x ? a = this.getOtherTargetXs() : L(i.data_xs) && (a = r.getXValuesOfXKey(o, r.data.targets)) : a = t.map((e, t) => t), a) r.data.xs[e] = a;
		else throw Error(`x is not defined for id = "${e}".`);
	});
}
var nr = {
	convertData(e, t) {
		let { config: n } = this, r = (e) => !e?.length || ye(e[0]) ? !1 : n.boost_useWorker === "auto" ? $n(e) >= Qn : !!n.boost_useWorker, i = n.boost_workerUrl ? { workerUrl: n.boost_workerUrl } : void 0, a = e;
		if (e.bindto && (a = {}, [
			"url",
			"mimeType",
			"headers",
			...
			let n = `data_${t}`;
			n in e && (a[t] = e[n]);
		})), a.url && t) Jn(a.url, a.mimeType, a.headers, er(a.keys, n), t);
		else if (a.json) Nn(r(a.json), "json", qn, t, i)(a.json, er(a.keys, n));
		else if (a.rows) Nn(r(a.rows), "rows", Kn, t, i)(a.rows);
		else if (a.columns) Nn(r(a.columns), "columns", Gn, t, i)(a.columns);
	...
	convertDataToTargets(e, t) {
		...
		let d = u.customX && u.categorized && i.axis_x_categories.length ? new Map(i.axis_x_categories.map((e, t) => [e, t])) : null, f = i.data_idConverter.bind(n.api), p = c.map((t, r) => {
			...
			return {
				...
				values: e.map((e, u) => {
					let f = e[s], h = e[t], g;
					if (h = h !== null && !isNaN(h) && !z(h) ? +h : R(h) || z(h) ? h : null, (c || a.hasRadar) && r === 0 && !P(f)) {
...
var ar = {
	isX(e) {
		let { config: t } = this, n = t.data_x && e === t.data_x, r = L(t.data_xs) && Ge(t.data_xs, e);
		return n || r;
	},
	isStackNormalized() {
		let { config: e } = this;
	...
	getXKey(e) {
		let { config: t } = this;
		return t.data_x ? t.data_x : L(t.data_xs) ? t.data_xs[e] : null;
	},
	getXValuesOfXKey(e, t) {
		let n = this, r = t && L(t) ? n.mapToIds(t) : [], i;
		return r.forEach((t) => {
	...
	isMultipleX() {
		return !this.config.axis_x_forceAsSingle && (L(this.config.data_xs) || this.hasType("bubble") || this.hasType("scatter"));
	},
	addName(e) {
		let { config: t } = this, n;
	...
	generateTargetX(e, t, n) {
		...
		return i?.isTimeSeries() ? a = ot.bind(r)(e || r.getXValue(t, n)) : i?.isCustomX() && !i?.isCategorized() && (a = A(e) ? +e : r.getXValue(t, n)), a;
	},
	updateXs(e) {
	...
	getMinMaxData() {
		let e = this, t = $.dataMinMax, n = e.cache.get(t);
		if (!n) {
	...
	getTotalPerIndex(e) {
		let t = this, { config: n } = t, r = e ? `${$.dataTotalPerIndex}-${e}` : $.dataTotalPerIndex, i = t.cache.get(r), a = i?.generation === t.state.dataGeneration ? i.value : null;
		if ((t.config.data_groups.length || t.isStackNormalized()) && !a) {
			a = [];
			let { targets: i } = t.data;
			if (t.isStackNormalizedPerGroup() && e) {
				let t = n.data_groups.find((t) => t.indexOf(e) >= 0);
				if (t) i = i.filter((e) => t.indexOf(e.id) >= 0);
				else return null;
			}
			i.forEach((e) => {
				e.values.forEach((e, t) => {
					a[t] || (a[t] = 0), a[t] += N(e.value) ? e.value : 0;
				});
			}), t.cache.add(r, {
	...
	getVisibleTotalPerIndex(e) {
		let t = this, { api: n, config: r, state: i, cache: a } = t, o = a.get($.visibleTotalPerIndex);
		if ((!o || o.generation !== i.dataGeneration) && (o = a.add($.visibleTotalPerIndex, {
			generation: i.dataGeneration,
			values: /* @__PURE__ */ new Map()
		})), o.values.has(e)) return o.values.get(e);
		let s = n.data.values.bind(n), { hiddenTargetIds: c } = i, l = t.getTotalPerIndex(e);
		if (l === null) return o.values.set(e, l), l;
		if (c.size) {
			let t = [...c];
			if (e) {
				let n = r.data_groups.find((t) => t.indexOf(e) >= 0);
				n && (t = t.filter((e) => n.indexOf(e) >= 0));
			}
			if (t.length) {
				let e = s(t, !1);
				e.length && (e = e.reduce((e, t) => e.map((e, n) => (N(e) ? e : 0) + t[n])), l = l.map((t, n) => t - e[n]));
			}
		}
		return o.values.set(e, l), l;
	},
	getTotalDataSum(e) {
		let t = this, n = $.dataTotalSum, r = t.cache.get(n);
	...
	getMaxDataCountTarget() {
		let e = this, { cache: t, state: n } = e, r = t.get($.maxDataCountTarget);
		...
		if (a > 1) {
			...
			i = e, i = et(Ze(i)).map((e, t, n) => ({
				x: e,
				index: o ? n.length - t - 1 : t
			}));
		} else a && (i = i[0].values.concat());
		return t.add($.maxDataCountTarget, {
			value: i,
	...
	mapToTargetIds(e) {
		let t = this;
		return e ? R(e) ? e.concat() : [e] : t.mapToIds(t.data.targets);
	},
	hasTarget(e, t) {
	...
	filterTargetsToShow(e) {
		let t = this;
		if (!e) {
			let { cache: e, data: n, state: r } = t, i = $.filteredTargets, a = e.get(i);
	...
	mapTargetsToUniqueXs(e) {
		let { axis: t } = this, n = [];
		return e?.length && (n = Ze(Qe(e.map((e) => e.values.map((e) => +e.x)))), n = t?.isTimeSeries() ? n.map((e) => /* @__PURE__ */ new Date(+e)) : n.map(Number)), et(n);
	},
	addTargetIds(e, t) {
		let { state: n } = this;
		ir(t).forEach((t) => n[e].add(t));
	},
	removeTargetIds(e, t) {
		let { state: n } = this;
		ir(t).forEach((t) => n[e].delete(t));
	},
	addHiddenTargetIds(e) {
		this.addTargetIds("hiddenTargetIds", e), this.cache.remove($.visibleTotalPerIndex);
	},
	removeHiddenTargetIds(e) {
		this.removeTargetIds("hiddenTargetIds", e), this.cache.remove($.visibleTotalPerIndex);
	},
	...
	getValuesAsIdKeyed(e) {
		...
		return e.forEach((e) => {
			...
			e.values.filter(({ value: e }) => A(e) || e === null).forEach((e) => {
				let { value: r } = e;
				if (r !== null && t.isCandlestickType(e) && (r = R(r) ? r.slice(0, 4) : [
					r.open,
					r.high,
					r.low,
					r.close
				]), R(r)) o.push(...r);
				else if (z(r) && "high" in r) o.push(...Object.values(r));
	...
	getDataIndexFromEvent(e) {
		...
		if (r) {
			...
			let r = n.axis_rotated, o = Et(t.chart.node()), l = i === "touch" && e.changedTouches ? e.changedTouches[0] : e, u = r ? l.clientY + o.y : l.clientX + o.x;
			if (At(t.svg)) {
				let e = [u, 0];
				r && e.reverse(), u = Dt(t.eventRect.node(), ...e)[r ? "y" : "x"];
			} else u -= r ? s.top : s.left;
			c = it(a, u, 0, a.length - 1, r);
		}
		return c;
	},
	...
	findClosest(e, t, n = !0) {
		...
		for (let e = 0; e < a.length; e++) {
			...
			if (c || l) {
				let e = c ? `.${K.chartBar}.${W.target}${r.getTargetSelectorSuffix(n.id)} .${K.bar}-${n.index}` : `.${Lt.chartCandlestick}.${W.target}${r.getTargetSelectorSuffix(n.id)} .${Lt.candlestick}-${n.index} path`;
	...
	convertValuesToStep(e) {
		let { axis: t, config: n } = this, r = n.line_step_type, i = t ? t.isCategorized() : !1, a = R(e) ? e.concat() : [e];
	...
	getRatio(e, t, n = !1) {
		...
		if (t && o.data.shown().length) {
			if (s = t.ratio || t.value, e === "arc") {
				...
				let e = r.getVisibleTotalPerIndex(r.isStackNormalizedPerGroup() ? t.id : void 0);
				if (e === null) return s;
				let n = e[t.index];
				t.ratio = N(t.value) && e && n ? t.value / n : 0, s = t.ratio;
	...
	isBubbleZType(e) {
		return this.isBubbleType(e) && (z(e.value) && ("z" in e.value || "y" in e.value) || R(e.value) && e.value.length >= 2);
	},
	isBarRangeType(e) {
		let t = this, { value: n } = e;
		return t.isBarType(e) && !t.isSubchartSourceTypeOf?.(e, H.CANDLESTICK) && R(n) && n.length >= 2 && n.every(N);
	},
	getDataById(e) {
...
var sr = {
	load(e, t) {
		...
		if (l) {
			t.filter && (l = l.filter(t.filter)), (t.type || t.types) && l.forEach((e) => {
				n.setTargetType(e.id, t.types?.[e.id] || t.type);
			});
		...
		if (n.state.isCanvasMode) {
			n.redraw({
				...
				withUpdateXDomain: !0,
				withLegend: !0
			}), n.updateTypesElements(), or.call(n, t.done, t.resizeAfter);
			return;
		}
	...
	unload(e, t) {
		...
		c.forEach((e) => {
			...
			r.withoutFadeIn[e] = !1, i.legend && i.legend.selectAll(`.${q.legendItem}${t}`).remove(), o && i.defs?.select(`#${n.getDefsPointId(t)}`).remove();
		}), n.data.targets = n.data.targets.filter((e) => !l.has(e.id)), r.hasFunnel && n.updateFunnel(n.data.targets), r.hasTreemap && n.updateTargetsForTreemap(n.data.targets), n.updateTypesElements(), a(i.svg.selectAll(c.map((e) => n.selectorTarget(e)))).style("opacity", "0").remove().call(Ke, s);
	}
}, cr = {
	setExpand(e, t, n) {
	...
	expandBarTypeShapes(e = !0, t, n, r) {
		...
		["bar", "candlestick"].filter((e) => i.$el[e]).forEach((a) => {
			r && i.$el[a].classed(W.EXPANDED, !1), i.getShapeByIndex(a, t, n).classed(W.EXPANDED, e);
		});
	},
	setOverOut(e, t) {
		let n = this, { config: r, state: { hasFunnel: i, hasRadar: a, hasTreemap: s }, $el: { main: c } } = n, l = z(t);
		if (l || t !== -1) {
			let u = r[e ? "data_onover" : "data_onout"].bind(n.api);
			if (r.color_onover && n.setOverColor(e, t, l), l) {
				let e = n.getTargetSelectorSuffix(t.id), r = i || s ? `${W.target + e} .${X.shape}` : Ft.arc + e;
				u(t, c.select(`.${r}`).node());
			} else if (r.tooltip_grouped) e && (a && n.isPointFocusOnly() ? n.showCircleFocus(n.getAllValuesOnIndex(t, !0)) : n.setExpand(t, null, !0)), !n.isMultipleX() && c.selectAll(`.${X.shape}-${t}`).each(function(e) {
				u(e, this);
			});
			else {
				let i = n.cache.get($.setOverOut) || [], a = c.selectAll(`.${X.shape}-${t}`).filter(function(e) {
				...
				}), n.cache.add($.setOverOut, i);
			}
		}
	},
	callOverOutForTouch(e) {
		let t = this, n = t.cache.get($.callOverOutForTouch);
		(z(e) && n ? e.id !== n.id : e !== n) && ((n || N(n)) && t.setOverOut(!1, n), (e || N(e)) && t.setOverOut(!0, e), t.cache.add($.callOverOutForTouch, e));
	},
	getDraggableSelection() {
		let e = this, { config: t, state: n } = e;
		return t.interaction_enabled && t.data_selection_draggable && e.drag ? c().on("drag", function(t) {
			n.event = t, e.drag(Ct(t, this));
		}).on("start", function(t) {
			n.event = t, e.dragstart(Ct(t, this));
		}).on("end", (t) => {
			n.event = t, e.dragend();
		}) : () => {};
	},
	dispatchEvent(e, t, n) {
		let r = this, { config: i, state: { eventReceiver: a, hasAxis: o, hasFunnel: s, hasRadar: c, hasTreemap: l }, $el: { eventRect: u, funnel: d, radar: f, svg: p, treemap: m } } = r, h = ((s || l) && a.rect || c && f.axes.select(`.${G.axis}-${t} text`) || u || r.getArcElementByIdOrIndex?.(t))?.node?.();
		if (h) {
			let u = r.isMultipleX(), f = i.axis_rotated, { width: g, left: _, top: v } = U(h);
			if (o && !c && !u) {
				let e = a.coords[t];
				e ? (g = e.w, _ += e.x, v += e.y) : (g = 0, _ = 0, v = 0);
			}
			let y = _ + (n ? n[0] : 0) + (u || f ? 0 : g / 2), b = v + (n ? n[1] : 0) + (f ? 4 : 0);
			if (At(p) && r.$el.eventRect) {
				let e = Dt(r.$el.eventRect.node(), y, b, !1);
				y = e.x, b = e.y;
			}
			let x = {
				screenX: y,
			...
			(s || l) && (h = (d ?? m).node()), Pt[/^(mouse|click)/.test(e) ? "mouse" : "touch"](h, e, x);
		}
	},
	setDragStatus(e) {
...
function pr(e) {
	let t = $.colorPattern, { body: n } = k, r = n[t];
	if (!r) {
		let i = e.classed(zt.colorPattern, !0).style("background-image");
		e.classed(zt.colorPattern, !1), i.indexOf(";") > -1 && (r = i.replace(/url[^#]*|["'()]|(\s|%20)/g, "").split(";").map((e) => e.trim().replace(/[\"'\s]/g, "")).filter(Boolean), n[t] = r);
	}
	return r;
}
var mr = [
	...
	generateColor() {
		let e = this, { $el: t, config: n } = e, r = [], i = n.area_linearGradient || n.bar_linearGradient || n.point_radialGradient, a = L(n.color_pattern) ? n.color_pattern : [...pr(t.chart) || mr], o = a;
		if (j(n.color_tiles)) {
			let t = n.color_tiles.bind(e.api)(), r = a.map((n, r) => {
				let i = n.replace(/[#\(\)\s,]/g, ""), a = `${e.state.datetimeId}-pattern-${i}-${r}`;
				return fr(t[r % t.length], n, a);
			});
	...
	generateTextBGColorFilter(e, t = {
		...
		if (e) {
			let a = [];
			M(e) ? a.push("") : z(e) ? a = Object.keys(e) : j(e) && (a = n.mapToTargetIds()), a.forEach((a) => {
				let o = `${i.datetimeId}-labels-bg${n.getTargetSelectorSuffix(a)}${M(e) ? n.getTargetSelectorSuffix(e) : ""}`, s = He(a === "" ? e : e?.[a] || "");
				if (r.select(`#${o}`).empty()) {
	...
	setOverColor(e, t) {
		...
		z(o) ? o = ({ id: e }) => e in a ? a[e] : n.color(e) : M(o) ? o = () => a : j(a) && (o = o.bind(n.api)), i.selectAll(z(t) ? `.${Ft.arc}${n.getTargetSelectorSuffix(t.id)}` : `.${X.shape}-${t}`).style("fill", o);
	}
};
//#endregion
...
function gr(e) {
	...
	return t && t.type === "brush" ? i = t.selection : r && (i = r.select(".bb-brush").node()) && (i = l(i)), i;
}
function _r(e) {
	let t = gr(e);
	return !t || t[0] === t[1];
...
function vr(e, t) {
	return t.map((t) => {
		let { values: n } = t, r = n[0], i = n[n.length - 1], a = r ? e.getXCacheKey?.(r.x) ?? r.x : "", o = i ? e.getXCacheKey?.(i.x) ?? i.x : "", s = e.getTargetType?.(t) ?? "";
		return `${t.id}:${s}:${e.state?.subchartSourceTypes?.[t.id] ?? ""}:${n.length}:${a}:${o}`;
	}).join("|");
}
function yr(e, t) {
...
function br(e, t) {
	L(t) && ((e.min === void 0 || t < e.min) && (e.min = t), (e.max === void 0 || t > e.max) && (e.max = t));
}
function xr(e, t) {
	for (let n = 0; n < t.length; n++) br(e, t[n]);
}
function Sr(e, t) {
	let n = {
		min: void 0,
	...
	for (let i = 0; i < t.length; i++) {
		let a = t[i], o = e.isCandlestickType?.(a), s = !o && !!e.isSubchartSourceTypeOf?.(a, H.CANDLESTICK), { values: c } = a;
		for (let t = 0; t < c.length; t++) {
			let i = c[t], a = i.value;
			if (!(A(a) || a === null)) continue;
			let l = s ? e.getSubchartCandlestickShapeValue?.(i, !0) : void 0;
			N(l) ? a = l : a !== null && (o || s) && (a = Array.isArray(a) ? a.slice(0, 4) : [
				a.open,
				a.high,
				a.low,
				a.close
			]), Array.isArray(a) ? xr(n, a) : z(a) && "high" in a ? xr(n, Object.values(a)) : e.isBubbleZType?.(i) ? br(n, r && e.getBubbleZData(a, "y")) : br(n, a);
		}
	}
	return [n.min, n.max];
}
function Cr(e, t) {
	...
	for (let r = 0; r < e.length; r++) {
		...
		for (let e = 0; e < i.length; e++) {
			let { x: r } = i[e];
			L(r) && (n === void 0 || (t === "min" ? r < n : r > n)) && (n = r);
		}
	}
	return n;
}
var wr = {
	getYDomainMinMaxBoth(e) {
		let t = this, { axis: n, cache: r, config: i, state: a } = t, o = yr(t, e) ? `${$.domainMinMax}_y_${vr(t, e)}` : null, s = o && r.get(o);
		if (s && s.generation === a.dataGeneration) return s.value;
		let c = i.data_groups, l = t.mapToIds(e), u = lt(l), d;
		if (c.length > 0) {
			...
			let p = [], m = [];
			for (let e in s) p.push(tt("min", s[e])), m.push(tt("max", f[e]));
			d = [tt("min", p), tt("max", m)];
		} else d = Sr(t, e);
		return o && r.add(o, {
	...
	getYDomain(e, t, n) {
		...
		if (h) {
			let e = _e(o.y.range()), t = r.getDataLabelLength(y, b, "width").map((t) => {
				let n = t / e;
	...
	getXDomainMinMax(e, t) {
		let n = this, { cache: r, state: i } = n, a = n.config[`axis_x_${t}`], o = yr(n, e) ? `${$.domainMinMax}_x_${t}_${vr(n, e)}` : null, s = o && r.get(o), c = s?.generation === i.dataGeneration ? s.value : void 0;
		c === void 0 && (c = Cr(e, t), o && r.add(o, {
			generation: i.dataGeneration,
			value: c
		}));
		let l = z(a) ? a.value : a;
		return l = F(l) && n.axis?.isTimeSeries() ? ot.bind(this)(l) : l, z(a) && a.fit && (t === "min" && l < c || t === "max" && l > c) && (l = void 0), F(l) ? l : c;
	},
	getXDomainPadding(e, t) {
		let n = this, { axis: r, config: i } = n, a = i.axis_x_padding, o = r.isTimeSeries() && t, s = _e(e), c;
	...
	updateXDomain(e, t, n, r, i) {
		...
		if (n && (c.domain(i || et(a.getXDomain(e), !o.axis_x_inverted)), s.xDomain = c.domain(), l.domain(c.domain()), a.brush?.scale(l)), t) {
			let e = i || !a.brush || _r(a) ? s.xDomain : gr(a).map(l.invert);
			c.domain(e);
		}
	...
	getZoomDomain(e = "zoom", t = !1) {
		...
		return e === "zoom" && (F(n.zoom_x_min) && (a = tt("min", [a, n.zoom_x_min])), F(n.zoom_x_max) && (o = tt("max", [o, n.zoom_x_max]))), [a, o];
	},
...
var Er = {
	...
	dataLabelFormat(e) {
		let t = this, n = t.config.data_labels, r = (e) => {
			let t = e;
			return R(e) ? t = e.join("~") : z(e) && (t = Object.values(e).join("~")), t;
		}, i = r;
...
function jr(e, t) {
	if (!t || t.empty()) return;
	let n = e.$el.legend?.selectAll(`.${q.legendItem}`);
	n && !n.empty() && (t = n);
	let r = [];
	t.each(function(e) {
		r.push({
	...
	let i = ut(r, (e) => e.id, (e) => e.node);
	e.cache.add($.legendItemMap, i);
}
function Mr(e) {
...
function Pr(e, t) {
	let n = e.state.legendTouch, r = n && Mr(t);
	r && (n.moved = n.moved || Math.abs(r.clientX - n.x) > Dr || Math.abs(r.clientY - n.y) > Dr);
}
function Fr(e, t, n) {
	Pr(e, n);
...
function Lr(e, t) {
	let { state: n } = e, r = n.legendLastTouchClickId === t && Date.now() - (n.legendLastTouchClickTime || 0) < Or;
...
function Rr(e) {
	...
	return { passive: !(me(t) && t) && (!isNaN(t) && t || null) === null };
}
var zr = {
	initLegend() {
		...
		t.legend_show ? (t.legend_contents_bindto || (n.legend = e.$el.svg.append("g").classed(q.legend, !0).attr("transform", e.getTranslate("legend"))), e.updateLegend()) : e.state.hiddenLegendIds = new Set(e.mapToIds(e.data.targets));
	},
	updateLegend(e, t, n) {
		...
		c.withTransition = We(c, "withTransition", !0), c.withTransitionForTransform = We(c, "withTransitionForTransform", !0), i.legend_contents_bindto && i.legend_contents_template ? r.updateLegendTemplate() : a.hasTreemap || r.updateLegendElement(e || r.mapToIds(r.data.targets), c), s.legend?.selectAll(`.${q.legendItem}`).classed(q.legendItemHidden, function(e) {
	...
	updateLegendTemplate() {
		...
		if (!r.empty()) {
			...
			t.forEach((t) => {
				let n = j(i) ? He(i.call(e.api, t, e.color(t), e.api.data(t)[0].values)) : at(i, {
					COLOR: e.color(t),
					TITLE: t
				});
				n && (a.push(t), o += n);
	...
	getLegendHeight() {
		let e = this, { current: t, isLegendRight: n, legendItemHeight: r, legendStep: i } = e.state;
		return e.config.legend_show ? n ? t.height : Math.max(e.config.padding?.mode === "fit" ? 10 : 20, r) * (i + 1) : 0;
	},
	opacityForUnfocusedLegend(e) {
		return e.classed(q.legendItemHidden) ? null : "0.3";
	},
	toggleFocusLegend(e, t) {
		let n = this, { $el: { legend: r }, $T: i } = n, a = n.mapToTargetIds(e);
		r && i(r.selectAll(`.${q.legendItem}`).filter((e) => a.indexOf(e) >= 0).classed(J.legendItemFocused, t)).style("opacity", function() {
			return t ? null : n.opacityForUnfocusedLegend.call(n, o(this));
		});
	},
	revertLegend() {
		let { $el: { legend: e }, $T: t } = this;
		e && t(e.selectAll(`.${q.legendItem}`).classed(J.legendItemFocused, !1)).style("opacity", null);
	},
	showLegend(e) {
	...
	hideLegend(e) {
		...
		n.legend_show && ye(e) && (n.legend_show = !1, r?.style("visibility", "hidden")), t.addHiddenLegendIds(e), r?.selectAll(t.selectorLegends(e)).style("opacity", "0").style("visibility", "hidden");
	},
	getLegendItemTextBox(e, t) {
		let n = this, { cache: r, state: i } = n, a, o = $.legendItemTextBox;
		return e && (a = !i.redrawing && r.get(o) || {}, a[e] || (a[e] = n.getTextRect(t, q.legendItem), r.add(o, a)), a = a[e]), a;
	},
	setLegendItem(e) {
		let t = this, { $el: n, api: r, config: i, state: a } = t, s = a.inputType === "touch", c = t.hasType("gauge"), l = i.boost_useCssRule, u = i.legend_item_interaction, d = u.dblclick ? "dblclick" : "click", f = u || j(i.legend_item_onclick), p = s ? Rr(t) : void 0, m = function(e, n) {
			if (!B(i.legend_item_onclick, r, n, !a.hiddenTargetIds.has(n))) {
				let { altKey: t, type: i } = e, s = o(this);
				i === "dblclick" || t ? a.hiddenTargetIds.size && !s.classed(q.legendItemHidden) ? r.show() : (r.hide(), r.show(n)) : (r.toggle(n), s.classed(J.legendItemFocused, !1));
			}
			s && (t.hideTooltip(), t.hideGridFocus?.(!0));
		};
		e.attr("class", function(e) {
			let n = o(this);
			return (!n.empty() && n.attr("class") || "") + t.generateClass(q.legendItem, e);
		}).style("visibility", (e) => t.isLegendToShow(e) ? null : "hidden"), i.interaction_enabled && (l && [
			[`.${q.legendItem}`, "cursor:pointer"],
			[`.${q.legendItem} text`, "pointer-events:none"],
			[`.${q.legendItemPoint} text`, "pointer-events:none"],
			[`.${q.legendItemTile}`, "pointer-events:none"],
			[`.${q.legendItemEvent}`, "fill-opacity:0"]
		].forEach((e) => {
			let [r, i] = e;
			...
			Fr(t, n, e) && (Ir(t, n), m.call(this, e, n));
		}, p), !s && e.on("mouseout", u || j(i.legend_item_onout) ? function(e, n) {
			B(i.legend_item_onout, r, n, !a.hiddenTargetIds.has(n)) || (o(this).classed(J.legendItemFocused, !1), c && t.undoMarkOverlapped(t, `.${Ht.gaugeValue}`), t.api.revert());
		} : null).on("mouseover", u || j(i.legend_item_onover) ? function(e, n) {
			B(i.legend_item_onover, r, n, !a.hiddenTargetIds.has(n)) || (o(this).classed(J.legendItemFocused, !0), c && t.markOverlapped(n, t, `.${Ht.gaugeValue}`), !a.transiting && t.isTargetToShow(n) && r.focus(n));
		} : null), !e.empty() && e.on("click mouseout mouseover") && e.style("cursor", t.getStylePropValue("pointer"))), jr(t, e);
	},
	getLegendItemById(e) {
		let t = this, n = t.cache.get($.legendItemMap);
		return n && n instanceof Map ? n.get(e) || null : (t.$el.legend?.selectAll(`.${q.legendItem}`).filter((t) => t === e))?.node() || null;
	},
	updateLegendElement(e, t) {
		let n = this, { config: r, state: i, $el: { legend: a }, $T: o } = n, s = r.legend_item_tile_type !== "circle", c = r.legend_item_tile_r, l = {
			...
			margins: [0],
			steps: {}
		}, f, p, m, h = e.filter((e) => !F(r.data_names[e]) || r.data_names[e] !== null), g = t.withTransition, _ = i.isLegendRight || i.isLegendInset, v = Ar.bind(n), y = n.getUpdateLegendPositions(h, u, d, _);
		...
		n.generateLegendItem(h, l, y, b, _, v), m = a.select(`.${q.legendBackground} rect`), i.isLegendInset && u.max.width > 0 && m.size() === 0 && (m = a.insert("g", `.${q.legendItem}`).attr("class", q.legendBackground).append("rect")), r.legend_tooltip && a.selectAll("title").data(h).text((e) => v(e, !1)), o(a.selectAll("text").data(h).text((e) => v(e)).each(function(e, t) {
			y(this, e, t);
		}), g).attr("x", b.xText).attr("y", b.yText), o(a.selectAll(`rect.${q.legendItemEvent}`).data(h), g).attr("width", (e) => d.widths[e]).attr("height", (e) => d.heights[e]).attr("x", b.xRect).attr("y", b.yRect), n.updateLegendItemPos(h, g, b), m && o(m, g).attr("height", n.getLegendHeight() - 12).attr("width", u.max.width * (u.step + 1) + 10), i.legendItemWidth = u.max.width, i.legendItemHeight = u.max.height, i.legendStep = u.step;
	},
	...
	generateLegendItem(e, t, n, i, a, o) {
		let s = this, { config: c, state: l, $el: { legend: u } } = s, d = c.legend_usePoint, f = c.legend_item_tile_r, p = c.legend_item_tile_type, m = p !== "circle", h = -200, g = u.selectAll(`.${q.legendItem}`).data(e).enter().append("g");
		if (s.setLegendItem(g), c.legend_tooltip && g.append("title").text((e) => e), g.append("text").text((e) => o(e)).each(function(e, t) {
			n(this, e, t);
		}).style("pointer-events", s.getStylePropValue("none")).attr("x", a ? i.xText : h).attr("y", a ? h : i.yText), g.append("rect").attr("class", q.legendItemEvent).style("fill-opacity", s.getStylePropValue("0")).attr("x", a ? i.xRect : h).attr("y", a ? h : i.yRect), d) {
			let e = [], t = s.getValidPointPattern();
			g.append((n) => {
				e.indexOf(n) === -1 && e.push(n);
				let i = t[e.indexOf(n) % t.length];
				return i === "rectangle" && (i = "rect"), k.createElementNS(r.svg, "hasValidPointType" in s && s.hasValidPointType(i) ? i : "use");
			}).attr("class", q.legendItemPoint).style("fill", kr.bind(s)).style("pointer-events", s.getStylePropValue("none")).attr("href", (e, t, n) => {
				let r = n[t].nodeName.toLowerCase(), i = s.getTargetSelectorSuffix(e);
				return r === "use" ? `#${l.datetimeId}-point${i}` : void 0;
			});
		} else g.append(m ? "line" : p).attr("class", q.legendItemTile).style("stroke", kr.bind(s)).style("pointer-events", s.getStylePropValue("none")).call((e) => {
			p === "circle" ? e.attr("r", f).style("fill", kr.bind(s)).attr("cx", a ? i.x2Tile : h).attr("cy", a ? h : i.yTile) : m && e.attr("stroke-width", t.height).attr("x1", a ? i.x1Tile : h).attr("y1", a ? h : i.yTile).attr("x2", a ? i.x2Tile : h).attr("y2", a ? h : i.yTile);
		});
	},
	updateLegendItemPos(e, t, n) {
		let r = this, { config: i, $el: { legend: a }, $T: s } = r, c = i.legend_usePoint, l = i.legend_item_tile_type, u = l !== "circle";
		if (c) {
			let r = a.selectAll(`.${q.legendItemPoint}`).data(e), c = i.legend_item_tile_type !== "circle", l = c ? i.legend_item_tile_width : i.legend_item_tile_r * 2, u = c ? i.legend_item_tile_height : i.legend_item_tile_r * 2, d = l * .75, f = u * .75, p = l / 8, m = u / 8;
			s(r, t).each(function() {
		...
		} else s(a.selectAll(`.${q.legendItemTile}`).data(e), t).style("stroke", kr.bind(r)).call((e) => {
	...
	redraw(e = {}) {
		...
		r.redrawing = !0, r.redrawGeneration++, (r.dirty.data || r.dirty.visibility || e.initializing) && r.dataGeneration++, (e.initializing || r.dirty.size || r.dirty.data || !r.rendered) && t.cache.remove([$.svgLeft]);
		...
		let { flow: l, initializing: u } = e, d = t.getWithOption(e), f = d.Transition ? n.transition_duration : 0, p = d.TransitionForExit ? f : 0, m = t.axis?.generateTransitions(d.TransitionForAxis ? f : 0), h = c.data || c.visibility || u;
		if (r.isCanvasMode && (t.setContainerSize(), t.updateHtmlLegend?.()), t.updateSizes(u), r.isCanvasMode) {
			let a = t.scale.zoom, o = a?.domain();
			a && (t.scale.zoom = null), t.updateScales(u, d.UpdateXDomain), a && (a.range(t.scale.x.range()), o && a.domain(o), t.scale.zoom = t.getCustomizedXScale(a), t.axis.x.scale(t.scale.zoom), t.scale.x.domain(n.zoom_rescale ? o : t.org.xDomain), t.scale.subX.domain(t.org.xDomain)), r.hasAxis && t.axis.syncAxisDomains(s, d, l), r.hasAxis && t.applyCanvasSubchartDomain?.();
			let c = h ? t.getDrawShape() : r._cachedDrawShape || t.getDrawShape();
			h && (r._cachedDrawShape = c), n.legend_show && i.legend && !(n.legend_contents_bindto && n.legend_contents_template) && t.positionHtmlLegend?.(), t.resizeCanvas?.(), r.canvasFocusKey = null, t.renderCanvasFrame(c, null, !0), u && t.updateTypesElements(), t.callPluginHook("$redraw", e, 0), r.redrawing = !1, r._targetsToShow = null, r._cachedDrawShape = null, t.mapToIds(t.data.targets).forEach((e) => {
				r.withoutFadeIn[e] = !0;
			}), B(n.onrendered, t.api);
			return;
		}
		d.Legend && n.legend_show ? (e.withTransition = !!f, !o && t.updateLegend(t.mapToIds(t.data.targets), e, m)) : d.Dimension && t.updateDimension(!0), n.data_empty_label_text && a.select(`text.${Z.text}.${W.empty}`).attr("x", r.width / 2).attr("y", r.height / 2).text(n.data_empty_label_text).style("display", s.length ? "none" : null), t.redrawTitle?.(), r.hasAxis ? (t.axis.redrawAxis(s, d, m, l, u), t.hasGrid?.() && t.updateGrid(), n.regions.length && t.updateRegion?.(), [
			"bar",
			"candlestick",
			"line",
			"area"
			...
			let n = V(e);
			(/^(line|area)$/.test(e) && t.hasTypeOf(n) || t.hasType(e)) && h && t[`update${n}`](d.TransitionForExit);
		}), i.text && a.selectAll(`.${Jt.selectedCircles}`).filter(t.isBarType.bind(t)).selectAll("circle").remove(), n.interaction_enabled && !l && d.EventRect && (t.redrawEventRect(), t.bindZoomEvent?.())) : (i.arcs && t.redrawArc(f, p, d.Transform), i.radar && t.redrawRadar(), i.polar && t.redrawPolar(), i.funnel && t.redrawFunnel(), o && t.updateTreemap(p)), !r.resizing && !o && (t.hasPointType() || r.hasRadar) ? h && t.updateCircle() : t.hasLegendDefsPoint?.() && t.data.targets.forEach(t.point("create", this)), t.hasDataLabel() && !t.hasArcType(null, ["radar"]) && h && t.updateText(), u && t.updateTypesElements(), t.generateRedrawList(s, l, f, d.Subchart, h), t.updateTooltipOnRedraw(), t.callPluginHook("$redraw", e, f);
	},
	generateRedrawList(e, n, r, i, a = !0) {
		...
		let u = n && o.generateFlow({
			...
			shape: l,
			xv: o.xv.bind(o)
		}), d = (r || u) && Mt(), f = o.getRedrawList(l, n, u, d), p = () => {
			u && u(), c.redrawing = !1, c._targetsToShow = null, c._cachedDrawShape = null, B(s.onrendered, o.api);
		};
		if (d && f.length) {
			let e = hn();
			t().duration(r).each(() => {
	...
	getRedrawList(e, t, n, r) {
		...
		if (o) {
			...
			for (let t in e.type) {
				let n = V(t), a = e.type[t];
				(/^(area|line)$/.test(t) && i.hasTypeOf(n) || i.hasType(t)) && m.push(i[`redraw${n}`](a, r));
			}
			!t && l.main && i.updateGridFocus && m.push(i.updateGridFocus());
		}
		return (!i.hasArcType() || s) && L(a.data_labels) && a.data_labels !== !1 && m.push(i.redrawText(f, p, t, r)), (i.hasPointType() || s) && !i.isPointFocusOnly() && i.redrawCircle && m.push(i.redrawCircle(u, d, r, n)), c && m.push(i.redrawTreemap(r)), m;
	},
	updateAndRedraw(e = {}) {
		let t = this, { config: n, state: r } = t, i;
		e.withTransition = We(e, "withTransition", !0), e.withTransform = We(e, "withTransform", !1), e.withLegend = We(e, "withLegend", !1), e.withUpdateXDomain = !0, e.withUpdateOrgXDomain = !0, e.withTransitionForExit = !1, e.withTransitionForTransform = We(e, "withTransitionForTransform", e.withTransition), e.withLegend && n.legend_show || (r.hasAxis && (i = t.axis.generateTransitions(e.withTransitionForAxis ? n.transition_duration : 0)), t.updateScales(), t.updateSvgSize(), t.transformAll(e.withTransitionForTransform, i)), t.redraw(e);
	}
};
//#endregion
//#region node_modules/billboard.js/dist-esm/ChartInternal/internals/scale.js
function Vr(t = "linear", n, r) {
	let i = {
		linear: e,
		log: u,
		_log: d,
...
var Hr = {
	getXScale(e, t, n, r) {
		let i = this, a = i.state.loading !== "append" && i.scale.zoom || Vr(i.axis.getAxisType("x"), e, t);
	...
	updateScales(t, n = !0) {
		...
		if (m) {
			...
			c.x = r.getXScale(m.x, h.x, g, () => i.x.tickOffset()), c.subX = r.getXScale(m.x, h.x, _, (e) => e % 1 ? 0 : (i.subX ?? i.x).tickOffset()), o.xAxisTick = i.getXAxisTickFormat(), o.subXAxisTick = i.getXAxisTickFormat(!0), i.setAxis("x", c.x, a.axis_x_tick_outer, t), a.subchart_show && i.setAxis("subX", c.subX, a.subchart_axis_x_tick_outer ?? a.axis_x_tick_outer, t), c.y = r.getYScale("y", m.y, h.y, c.y ? c.y.domain() : a.axis_y_default, c.y), c.subY = r.getYScale("y", m.subY, h.subY, c.subY ? c.subY.domain() : a.axis_y_default, c.subY), i.setAxis("y", c.y, a.axis_y_tick_outer, t), a.subchart_show && a.subchart_axis_y_show && i.setAxis("subY", c.subY, a.subchart_axis_y_tick_outer ?? a.axis_y_tick_outer, t), (a.axis_y2_show || a.subchart_axis_y2_show) && (c.y2 = r.getYScale("y2", m.y, h.y, c.y2 ? c.y2.domain() : a.axis_y2_default, c.y2), c.subY2 = r.getYScale("y2", m.subY, h.subY, c.subY2 ? c.subY2.domain() : a.axis_y2_default, c.subY2), i.setAxis("y2", c.y2, a.axis_y2_tick_outer, t), a.subchart_show && a.subchart_axis_y2_show && i.setAxis("subY2", c.subY2, a.subchart_axis_y2_tick_outer ?? a.axis_y2_tick_outer, t));
		} else if (h) {
	...
	xx(e) {
		let { config: t, scale: { x: n, zoom: r } } = this;
		return e ? (t.zoom_enabled && r ? r : n)(A(e.x) ? e.x : e) : null;
	},
	xv(e) {
		let t = this, { axis: n, config: r, scale: { x: i, zoom: a } } = t, o = r.zoom_enabled && a ? a : i, s = t.getBaseValue(e);
		return n.isTimeSeries() ? s = ot.call(t, s) : n.isCategorized() && M(s) && (s = r.axis_x_categories.indexOf(s)), o(s);
	},
	yv(e) {
	...
	getCurrentHeight() {
		let e = this, { config: t, state: n, $el: r } = e, i = t.size_height;
		if (!i) {
			let t = n.isCanvasMode ? r.chart?.node() : null, a = t?.style.minHeight;
			a && (t.style.minHeight = ""), i = e.getParentHeight(), a && (t.style.minHeight = a);
			let o = t && parseFloat(e.canvasEngine?.canvas.style.height) || 0, s = n.current.height - o;
			s > 0 && Math.round(i) === Math.round(o) && (i += s);
		}
		return i > 0 ? i : 320 / (e.hasType("gauge") && !t.gauge_fullCircle ? 2 : 1);
	},
	getParentRectValue(e) {
		let t = `offset${V(e)}`, n = this.$el.chart.node(), r = 0;
	...
	getSvgLeft(e) {
		...
		let o = r.axis_rotated, s = o || !o && !r.axis_y_inner, c = o ? G.axisX : G.axisY, l = a.main.select(`.${c}`).node(), u = i && r[`axis_${o ? "x" : "y"}_label`], d = i && (M(u) || M(u.text) || /^inner-/.test(u?.position)) ? a.main.select(`.${c}-label`) : null, f = d && !d.empty() ? d.node() : null, p = !e, m = {
			label: f ? U(f, p) : null,
			leftAxis: l && s ? U(l, p) : null,
			chart: U(a.chart.node(), p)
		...
		return n.add($.svgLeft, b), b;
	},
	previewResize() {
		let e = this, { state: t, $el: n } = e, { current: r } = t, i = e.getCurrentWidth(), a = e.getCurrentHeight();
		if (i && a && r.width && r.height && (i !== r.width || a !== r.height)) {
			if (t.isCanvasMode) {
				let t = e.canvasEngine?.canvas;
				if (!t) return;
				n.chart.style("min-height", `${a}px`), t.style.width = `${i}px`, t.style.height = `${Math.max(0, a - (e.getCanvasBottomLegendHeight?.() ?? 0))}px`;
			} else if (n.svg) n.svg.attr("viewBox", `0 0 ${r.width} ${r.height}`).attr("preserveAspectRatio", "none").attr("width", i).attr("height", a);
			else return;
			t.resizePreview = !0;
		}
	},
	clearResizePreview() {
		let { config: e, state: t, $el: n } = this;
		t.resizePreview && (t.resizePreview = !1, !t.isCanvasMode && n.svg && e.resize_auto !== "viewBox" && n.svg.attr("viewBox", null).attr("preserveAspectRatio", null));
	},
	updateDimension(e) {
	...
	updateSvgSize() {
		...
		if (e.clearResizePreview(), t.resize_auto === "viewBox" ? s.attr("viewBox", `0 0 ${r.width} ${r.height}`) : s.attr("width", r.width).attr("height", r.height), i) {
			let t = s.select(`.${Yt.brush} .overlay`), r = {
				width: 0,
				height: 0
			};
	...
	getResettedPadding(e) {
		...
		return t.padding === !1 ? !n && Object.keys(e).forEach((n) => {
			r[n] = !ye(t.data_labels) && t.data_labels !== !1 && n === "top" ? e[n] : 0;
		}) : r = e, r;
	},
	updateSizes(e) {
		...
		if (r.margin = !o && a ? {
			...
			let e = t.hasType("gauge"), i = n.legend_show && r.isLegendRight, a = (r.hasRadar && t.cache.get($.radarTextWidth)) ?? 0;
	...
	setCssRule(e, t, n, r) {
		...
		return a.boost_useCssRule ? (a) => {
			a.each((a) => {
				let c = r && r?.call(i, a), l = `${e ? `.${X.shapes + i.getTargetSelectorSuffix(a.id)}` : ""}${t}`;
				t in o && s.sheet.deleteRule(o[l]), i.state.cssRule[l] = Tt(s, l, n.filter(Boolean).map((e) => M(c) && e.indexOf(":") === -1 ? `${e}: ${c}` : e || ""));
			});
		} : () => {};
	},
	getStylePropValue(e) {
...
function Jr(e, t, n) {
	let { config: r, $T: i } = this, a = r.axis_rotated, { border: { padding: s = "3 5", radius: c = 10, stroke: l = "#000", strokeWidth: u = 1, fill: d = "none" } } = r.data_labels, f = st(s), p = r.data_labels.border !== !0, m = wt(e), h = o(e.previousElementSibling);
	(h.empty() || h.node()?.tagName !== "rect" || !h.attr("class")?.includes(n)) && (h = o(e.parentNode).insert("rect", () => e).attr("class", `${Z.textBorderRect} ${n}`).attr("width", m.width + (p ? f.left + f.right : 0)).attr("height", m.height + (p ? f.top + f.bottom : 0)), p && h.style("fill", d).style("stroke", l).style("stroke-width", `${u}px`).attr("rx", c).attr("ry", c)), i(h).attr("x", t.x - (p ? f.left : 0) - (a ? 0 : m.width / 2)).attr("y", t.y - (p ? f.top : 0) - m.height / 4 * 3.2);
}
function Yr(e = 0, t) {
	let { config: n } = this;
...
function Xr() {
	...
	(e.state.arcWidth ? e.getArcLabelConfig("image") : n.data_labels.image) && t.filter(function() {
		...
		r && o(this.parentNode)?.insert("image", `${this.getAttribute("class")?.replace(/(?:^(.)|\s)/g, ".$1") ?? "text"}`).style("opacity", "0").attr("href", (e) => at(r, { ID: "id" in e ? e.id : e.data.id })).attr("class", Z.textLabelImage).style("pointer-events", "none").attr("width", i).attr("height", a).attr("transform", s ? `translate(${s.x ?? 0} ${s.y ?? 0})` : null);
	});
}
function Zr(e) {
...
function Qr(e, t, n) {
	let r = this, { config: i, state: { arcWidth: a, hasTreemap: s } } = r, c = i.axis_rotated, l = o(e.previousElementSibling), u = (e) => (a ? e.textContent : e.style.opacity !== "0" && e.style.fillOpacity !== "0") && this.previousElementSibling?.tagName !== "image";
	if (!l.empty() && l.node()?.tagName === "image") {
		let i = n || U(e), a = l.attr("width") / 2, o = l.attr("height") / 2, d = t.x - a, f = t.y - o - i.height / 2;
		c ? t.x += a : (s && (d = -a, f = -(o * 2 + i.height)), r.hasType("pie") || r.hasType("polar") || (t.y += o)), r.$T(l).style("opacity", u(e) ? null : "0").attr("x", d).attr("y", f);
	}
}
function $r(e) {
	return ut(e, (e) => e, (e) => wt(e, !0));
}
//#endregion
...
var ei = {
	opacityForText(e) {
		let t = this;
		return t.isBarType(e) && !Yr.call(t, Math.abs(t.getRatio("bar", e)), "bar") ? "0" : t.hasDataLabel() ? null : "0";
	},
	initText() {
		let { $el: e } = this;
		e.main.select(`.${W.chart}`).append("g").attr("class", Z.chartTexts).style("pointer-events", e.funnel || e.treemap ? "none" : null);
	},
	...
	updateText() {
		let e = this, { $el: t, $T: n, config: r, axis: i } = e, a = e.getClass("text", "index"), s = r.data_labels.centered, c = t.main.selectAll(`.${Z.texts}`).selectAll(`.${Z.text}`).data(e.labelishData.bind(e));
		n(c.exit()).style("fill-opacity", "0").remove(), t.text = c.enter().append("text").merge(c).attr("class", a).attr("text-anchor", (t) => {
			...
			a = e.isTreemapType(t) ? e.treemapDataLabelFormat(t)(i) : e.dataLabelFormat(t.id)(a, t.id, t.index, r), N(a) ? this.textContent = a : xt(i, a, void 0, !0);
		}), Xr.call(e);
	},
	updateTextColor(e) {
	...
	redrawText(e, t, n, r) {
		let i = this, { $T: a, axis: o, config: s, state: { hasTreemap: c } } = i, l = rt(!0), u = s.axis_rotated, d = s.data_labels.rotate, f = Gr(d), p = d ? `rotate(${d})` : "", m = i.$el.text.style("fill", i.getStylePropValue(i.updateTextColor)).attr("filter", (e) => i.updateTextBGColor.bind(i)(e, s.data_labels_backgroundColors)).style("fill-opacity", n ? 0 : i.opacityForText.bind(i)), h = /* @__PURE__ */ new Map(), g = [];
		return m.each(function(e) {
			let t = this;
			h.set(t, { rect: U(t) }), s.data_labels.centered && (i.isBarType(e) || i.isTreemapType(e)) && g.push(t);
		}), g.length > 0 && $r(g).forEach((e, t) => {
			let n = h.get(t);
			n && (n.bbox = e);
		}), m.each(function(n, m) {
			...
			d && (y = Kr.bind(i)(n, y, f, u, v), _.attr("text-anchor", f)), Qr.call(i, this, y, g?.rect), this.childElementCount || d ? _.attr("transform", `translate(${y.x} ${y.y}) ${p}`) : _.attr("x", y.x).attr("y", y.y), s.data_labels.border && Jr.call(i, _.node(), y, `${Z.textBorderRect}-${m}`);
		}), !0;
	},
	getTextRect(e, t) {
		let n = this, r, i, a;
		Array.isArray(e) ? r = `${$.textRect}-${e.join("_")}` : (i = e.node?.() ?? e, /text/i.test(i.tagName) || (i = i.querySelector("text")), a = i.textContent, r = `${$.textRect}-${a.replace(/\W/g, "_")}`);
		let s = n.cache.get(r) || [];
		return s.length === 0 && ((n.$el.svg || n.$el.chart.select("svg")).selectAll(`.${W.dummy}`).data(a ? [a] : e).enter().append("text").style("visibility", "hidden").style("font", i ? o(i).style("font") : null).classed(t || W.dummy, !0).text((e) => e).each(function(e, t) {
			s[t] = U(this);
	...
	generateXYForText(e, t) {
		...
		return i && o.push("funnel"), r && o.push("radar"), a && o.push("treemap"), o.forEach((t) => {
			s[t] = n[`generateGet${V(t)}Points`](e[t], !1);
		}), function(e, t, r) {
	...
	getXForText(e, t, n, r) {
		...
		return (o || c || s) && (l += i.getCenteredTextPos(t, e, n, "x", r)), l + qr.call(this, t, "x");
	},
	getYForText(e, t, n, r) {
		let i = this, { axis: a, config: o, state: s } = i, c = o.axis_rotated, l = o[`axis_${a?.getId(t.id)}_inverted`], u = i.isBarType(t), d = i.isFunnelType(t), f = i.isTreemapType(t), p = o.point_r, m = r?.rect || U(n), { value: h } = t, g = 3, _;
		...
		return (!c || f) && (_ += i.getCenteredTextPos(t, e, n, "y", r)), _ + qr.call(this, t, "y");
	},
	markOverlapped(e, t, n) {
		let r = t.$el.arcs.selectAll(n), i = r.filter((t) => t.data.id !== e), a = r.filter((t) => t.data.id === e), s = Ot(a.node()), c = (e, t) => Math.sqrt(e * e + t * t);
		if (!a.node()) return;
		let l = parseInt(a.style("font-size"), 10), u = [];
		i.each(function() {
			let e = Ot(this), t = c(s.e, s.f) > c(e.e, e.f) ? a : o(this), n = Math.ceil(Math.abs(s.e - e.e)) < Math.ceil(t.node().getComputedTextLength()), r = Math.ceil(Math.abs(s.f - e.f)) < l;
			u.push({
				node: this,
				overlaps: n && r
			});
		}), u.forEach(({ node: e, overlaps: t }) => {
			o(e).classed(Z.TextOverlapping, t);
		});
	},
	undoMarkOverlapped(e, t) {
		e.$el.arcs.selectAll(t).each(function() {
			gt([this, this.previousSibling]).classed(Z.TextOverlapping, !1);
		});
	}
};
//#endregion
//#region node_modules/billboard.js/dist-esm/ChartInternal/internals/title.js
function ti(e = "left", t) {
	let n = N(t);
...
var ri = {
	initTitle() {
		...
		e.title_text && (t.title = t.svg.append("g"), xt(t.title.append("text").style("text-anchor", ti(e.title_position)).attr("class", Z.title), e.title_text, [.3, 1.5]));
	},
	redrawTitle() {
		let e = this, { config: t, state: { current: n }, $el: { title: r } } = e;
		if (r) {
			let i = ti(t.title_position, n.width), a = (t.title_padding.top || 0) + e.getTextRect(e.$el.title, Z.title).height;
	...
	initTooltip() {
		let e = this, { config: t, $el: n } = e;
		n.tooltip = o(t.tooltip_contents.bindto), n.tooltip.empty() && (n.tooltip = n.chart.append("div").attr("class", Xt.tooltipContainer).style("position", "absolute").style("pointer-events", "none").style("display", "none")), e.bindTooltipResizePos();
	},
	initShowTooltip() {
		let e = this, { config: t, $el: n, state: { hasAxis: r, hasRadar: i } } = e;
		if (t.tooltip_init_show) {
			let a = !(r || i);
			e.axis?.isTimeSeries() && M(t.tooltip_init_x) && (t.tooltip_init_x = ot.call(e, t.tooltip_init_x)), e.api.tooltip.show({ data: { [a ? "index" : "x"]: t.tooltip_init_x } });
			let o = t.tooltip_init_position;
			if (!t.tooltip_contents.bindto && !ye(o)) {
	...
	getTooltipHTML(...e) {
		...
		return He(j(r.tooltip_contents) ? r.tooltip_contents.bind(n)(...e) : t.getTooltipContent(...e));
	},
	getTooltipContent(e, t, n, r) {
		...
		let S = i.getTooltipContentTemplate(b), C = e.length, w, T, E, D, ee = 0;
		for (; ee < C; ee++) {
			T = e[ee];
			let t = T && _(T);
			if (T && (t || t === 0)) {
				...
				if (!T.ratio && c.arcs && (E = ["arc", i.$el.arcs.select(`path.${Ft.arc}-${T.id}`).data()[0]], T.ratio = i.getRatio(...E)), E = [
					T.ratio,
					T.id,
					T.index
				], i.isAreaRangeType(T)) {
				...
				if (D !== void 0) {
					...
					let e = p(T.name ?? T.id, ...E), t = v(T), n = {
						CLASS_TOOLTIP_NAME: Xt.tooltipName + i.getTargetSelectorSuffix(T.id),
	...
	getTooltipContentTemplate(e) {
		return (e || `<table class="{=CLASS_TOOLTIP}"><tbody>
			...
			</tbody></table>`).replace(ii, "").split(ai);
	},
	setTooltipPosition(e, t) {
		...
		if (!l && d) {
			let l = e ?? d.data, [f, p] = Ct(a.event, t ?? o?.node()), m = {
				x: f,
				y: p
			};
			...
			let { width: h = 0, height: g = 0 } = d, _ = r.tooltip_position?.bind(n.api)(l, h, g, o?.node(), m) ?? (c && At(c) ? n.getTooltipPositionViewBox.bind(n)(h, g, m) : n.getTooltipPosition.bind(n)(h, g, m));
			["top", "left"].forEach((e) => {
				let t = _[e];
	...
	getTooltipPositionViewBox(e, t, n) {
		...
		let p = Dt(u, d, f, !1), m = U(u), h = Dt(u, 20, 0, !1).x, g = p.y, _ = p.x + e / 2 + h;
	...
	showTooltip(e, t) {
		...
		if (!l || l.current !== s) {
			let { index: t, x: a } = c;
			u ||= e.slice(), B(r.tooltip_onshow, n.api, e), i.html(n.getTooltipHTML(e, n.axis ? n.axis.getXAxisTickFormat() : n.categoryName.bind(n), n.getDefaultValueFormat(), n.color)).style("display", null).style("visibility", null), i.datum({
				index: t,
				x: a,
				current: s,
				data: e,
			...
			}), B(r.tooltip_onshown, n.api, e), n._handleLinkedCharts(!0, t);
		}
	...
	hideTooltip(e) {
		...
		if (r && r.style("display") !== "none" && (!n.tooltip_doNotHide || e)) {
			let e = r.datum().data ?? [];
			B(n.tooltip_onhide, t, e), r.style("display", "none").datum(null), B(n.tooltip_onhidden, t, e);
		}
	},
	...
	updateTooltipOnRedraw(e, t) {
		...
		if (!n.state.isCanvasMode && s?.style("display") === "block" && c) {
			...
			if (l || u) {
				...
				setTimeout(() => {
					let r = [e, t].every(Number.isFinite) && k.elementFromPoint(e, t), i = r && o(r).datum();
					if (i) {
	...
	getTranslate(e, t = 0) {
		...
		if (t && /^(x|y2?)$/.test(e) && (o = n.getAxisSize(e) * t), e === "main") s = ge(i.margin.left), c = ge(i.margin.top);
		else if (e === "context") s = ge(i.margin2.left), c = ge(i.margin2.top);
		...
		else if (e === "subY") s = 0, c = a ? i.height2 : 0;
		else if (e === "subY2") s = a ? 0 : i.width2, c = a ? -1 : 0;
	...
	transformMain(e, t) {
		let n = this, { $el: { main: r }, $T: i } = n, a = t?.axisX ? t.axisX : i(r.select(`.${G.axisX}`), e), o = t?.axisY ? t.axisY : i(r.select(`.${G.axisY}`), e), s = t?.axisY2 ? t.axisY2 : i(r.select(`.${G.axisY2}`), e);
		i(r, e).attr("transform", n.getTranslate("main")), a.attr("transform", n.getTranslate("x")), o.attr("transform", n.getTranslate("y")), s.attr("transform", n.getTranslate("y2")), r.select(`.${Ft.chartArcs}`).attr("transform", n.getTranslate("arc"));
	},
	transformAll(e, t) {
	...
	isValidChartType(e) {
		return !!(e && Object.values(H).indexOf(e) > -1);
	},
	getSubchartTargetType(e) {
		let t = this, { config: n } = t, r = M(e) ? e : e?.id, i = n.subchart_types || {}, a = n.subchart_type, o = n.data_types || {}, s = r && i[r];
		return s && t.isValidChartType(s) ? s : a && t.isValidChartType(a) ? a : r && o[r] || n.data_type || H.LINE;
	},
	getTargetType(e) {
		let { config: t } = this, n = M(e) ? e : e?.id;
		return n && t.data_types?.[n] || t.data_type || H.LINE;
	},
	getSubchartSourceTargetType(e) {
		let { state: t } = this, n = M(e) ? e : e?.id;
		return n && t.subchartSourceTypes?.[n] || this.getTargetType(e);
	},
	isSubchartSourceTypeOf(e, t) {
		let n = this.getSubchartSourceTargetType(e);
		return R(t) ? t.indexOf(n) >= 0 : n === t;
	},
	withSubchartTypeContext(e) {
		let t = this, { config: n, data: r, state: i } = t, a = n.data_type, o = n.data_types, s = i.current.types, c = i.subchartSourceTypes, l = {}, u = {}, d = n.subchart_type;
		t.mapToIds(r.targets).forEach((e) => {
			u[e] = t.getTargetType(e), l[e] = t.getSubchartTargetType(e);
		}), n.data_type = d && t.isValidChartType(d) ? d : a, n.data_types = l, i.current.types = [], i.subchartSourceTypes = u;
		try {
			return e();
		} finally {
			n.data_type = a, n.data_types = o, i.current.types = s, i.subchartSourceTypes = c;
		}
	},
	setTargetType(e, t) {
	...
	updateTypesElements() {
		...
		Object.keys(H).forEach((n) => {
			let r = H[n], i = e.hasType(r, null, !0), a = t.types.indexOf(r);
	...
	hasTypeOf(e, t, n = []) {
		return e in ft && !ft[e].filter((e) => n.indexOf(e) === -1).every((e) => !this.hasType(e, t));
	},
	isTypeOf(e, t) {
		let n = M(e) ? e : e.id, r = this.config && this.getTargetType(n);
		return R(t) ? t.indexOf(r) >= 0 : r === t;
	},
	hasPointType() {
		let e = this;
	...
	isLineType(e) {
		let t = M(e) ? e : e.id;
		return !this.config.data_types[t] || this.isTypeOf(t, ft.Line);
	},
	isStepType(e) {
		return this.isTypeOf(e, ft.Step);
	},
	isSplineType(e) {
		return this.isTypeOf(e, ft.Spline);
	},
	isAreaType(e) {
		return this.isTypeOf(e, ft.Area);
	},
	isAreaRangeType(e) {
		return this.isTypeOf(e, ft.AreaRange);
	},
	isBarType(e) {
	...
	isCirclePoint(e) {
		...
		return e?.tagName === "circle" || t.point_type === "circle" && (!n || R(n) && n.length === 0);
	},
	lineData(e) {
...
function pi(e, t, n) {
	let r = n ? mi(e, t, n) : void 0;
	return N(r) ? r : e.isCandlestickType?.(t) ? e.getCandlestickData?.(t)?.close : e.getBaseValue(t);
}
function mi(e, t, n) {
	if (!n || e.isCandlestickType?.(t) || !e.isSubchartSourceTypeOf?.(t, H.CANDLESTICK)) return;
	let r = e.getCandlestickData?.(t);
	if (r) return e.isBarType(t) ? N(r.open) && N(r.close) ? r._isUp ? r.close : r.open : void 0 : N(r.close) ? r.close : void 0;
}
function hi(e, t, n) {
	return N(mi(e, t, n)) && e.isBarType(t);
}
function gi(e, t, n) {
	if (!hi(e, t, n)) return null;
	if (e.getCandlestickData?.(t)?._isUp) return e.color(t);
	let r = e.config.candlestick_color_down;
	return (r && typeof r == "object" ? r[t.id] : r) || e.color(t);
}
function _i(e) {
	let t = this, n;
	if (di(t, e)) {
...
var bi = {
	...
	getShapeIndices(e) {
		let t = this, { config: n } = t, r = n.data_xs, i = L(r), a = {}, o = i ? {} : 0;
		return i && Ze(Object.keys(r).map((e) => r[e])).forEach((e) => {
			o[e] = 0, a[e] = {};
	...
	getIndicesMax(e) {
		if (!L(this.config.data_xs)) return e.__max__;
		let t = 0;
	...
	getShapeY(e) {
		...
		return (r) => {
			let { value: i } = r, a = e ? mi(t, r, e) : void 0;
			return N(r) ? i = r : N(a) ? i = a : t.isAreaRangeType(r) ? i = t.getBaseValue(r, "mid") : n ? i = t.getRatio("index", r, !0) : t.isBubbleZType(r) ? i = t.getBubbleZData(r.value, "y") : t.isBarRangeType(r) && (i = i[1]), t.getYScaleById(r.id, e)(i);
		};
	},
	getShapeYMin(e, t = !1) {
		let n = this, r = n.axis.getId(e), [i] = n.getYScaleById(e, t).domain(), a = n.config[`axis_${r}_inverted`];
		return !n.isGrouped(e) && !a && i > 0 ? i : 0;
	},
	getShapeOffsetData(e, t) {
		let n = this, r = n.orderTargets(n.filterTargetsToShow(n.data.targets.filter(e, n))), i = n.state.dataGeneration, a = r.map((e) => e.id).join("_"), o = `${$.shapeOffset}_${t ? "sub" : "main"}_${a}`, s = n.cache.get(o);
		if (s?.generation === i) return s;
		let c = n.isStackNormalized(), l = r.map((e) => {
			let r = e.values, i = {};
			n.isStepType(e) && (r = n.convertValuesToStep(r));
			let a = r.reduce((e, r) => {
				let a = Number(r.x), o = pi(n, r, t);
				return e[a] = r, i[a] = c ? n.getRatio("index", r, !0) : o, e;
			}, {});
			return {
				id: e.id,
				rowValues: r,
				rowValueMapByXValue: a,
				values: i
			};
		}), u = {
			generation: i,
			indexMapByTargetId: r.reduce((e, { id: t }, n) => (e[t] = n, e), {}),
			shapeOffsetTargets: l
		};
		return n.cache.add(o, u), u;
	},
	getShapeOffset(e, t, n) {
		let r = this, { shapeOffsetTargets: i, indexMapByTargetId: a } = r.getShapeOffsetData(e, n), o = r.config.data_groupsZeroAs, s = null;
		...
		return (e, c) => {
			let { id: l, value: u, x: d } = e, f = pi(r, e, n), p = r.getIndices(t, e), m = r.getYScaleById(l, n);
			if (r.isBarRangeType(e)) return m(u[0]);
			let h = Number(d), g = m(o === "zero" ? 0 : r.getShapeYMin(l, n)), _ = g, v = s?.get(l) ?? i.filter((e) => e.id !== l && p[e.id] === p[l]);
			for (let e of v) {
				let { id: t, rowValueMapByXValue: i, rowValues: s, values: u } = e;
				if (a[t] < a[l]) {
					let e = u[h], t = s[c];
					(!t || Number(t.x) !== h) && (t = i[h]);
					let a = t && pi(r, t, n);
	...
	generateGetLinePoints(e, t, n) {
		let r = this, { config: i } = r, a = r.getShapeX(0, e, t), o = r.getShapeY(t), s = r.getShapeOffset(n || r.isLineType, e, t), c = r.getYScaleById.bind(r), l = /* @__PURE__ */ new Map();
		return (e, n) => {
			let u = l.get(e.id);
			u === void 0 && (u = c.call(r, e.id, t)(r.getShapeYMin(e.id, t)), l.set(e.id, u));
			let d = s(e, n) || u, f = a(e), p = o(e);
			i.axis_rotated && (e.value > 0 && p < u || e.value < 0 && u < p) && (p = u);
			let m = [f, p - (u - d)];
			return [
				m,
				m,
	...
	generateGetAreaPoints(e, t) {
		...
		return function(e, l) {
			let u = c.get(e.id);
			u === void 0 && (u = s.call(n, e.id, t)(n.getShapeYMin(e.id, t)), c.set(e.id, u));
	...
	generateGetBarPoints(e, t) {
		...
		return (e, i) => {
			...
			f || (f = {
				y0: u.call(n, a, t)(n.getShapeYMin(a, t)),
	...
	circleY(e, t) {
		let n = this, r = e.id, i;
		return n.isGrouped(r) && (i = _i.bind(n)(e)), i ? i(e, t)[0][1] : n.getYScaleById(r)(n.getBaseValue(e));
	},
	circleX(e) {
		return this.xx(e);
	},
	updateCircleY(e = !1) {
		let t = this, n = fi(t), r = t.generateGetLinePoints(t.getShapeIndices(n), e, n), i = t.getShapeY(e);
		return (e, n) => t.isGrouped(e.id) && di(t, e) ? r(e, n)[0][1] : i(e);
	},
	getSubchartCandlestickShapeValue(e, t) {
		return mi(this, e, t);
	},
	isSubchartCandlestickBarValue(e, t) {
		return hi(this, e, t);
	},
	getSubchartCandlestickBarColor(e, t) {
		return gi(this, e, t);
	},
	pointR(e) {
	...
	getBarW(e, t, n) {
		let r = this, { config: i, org: a, scale: o, state: s } = r, c = r.getMaxDataCount(), l = e === "bar" && i.data_groups?.length, u = `${e}_width`, { k: d } = r.getZoomTransform?.() ?? { k: 1 }, f = [i.axis_x_min ?? a.xDomain[0], i.axis_x_max ?? a.xDomain[1]].map((e) => r.axis.isTimeSeries() ? ot.call(r, e) : Number(e)), p = t.tickInterval(c);
	...
	getShapeByIndex(e, t, n) {
		...
		return o = o && !o.empty() ? o.filter((e) => !n || e.id === n).filter((e) => !A(t) || e.index === t) : (n ? i.main.selectAll(`.${Q[`${e}s`]}${r.getTargetSelectorSuffix(n)}`) : i.main).selectAll(`.${Q[e]}${a}`), o;
	},
	isWithinShape(e, t) {
		let n = this, r = o(e), i;
	...
	getInterpolate(e) {
		return ui[this.getInterpolateType(e)];
	},
	getCurve(e) {
		let t = this;
	...
	isWithinBar(e) {
		let t = Ct(this.state.event, e), [n, r, i] = St(e), a = Math.min(n.x, r.x), o = Math.min(n.y, r.y), s = this.config.bar_sensitivity, c = Math.abs(i.x - r.x), l = Math.abs(n.y - r.y), u = a - s, d = a + c + s, f = o + l + s, p = o - s;
...
function xi() {
	return O.performance?.now?.() ?? Date.now();
}
function Si(e) {
	return e.hasArcType() ? "arc charts" : e.hasType("funnel") ? "funnel chart" : null;
}
function Ci(e) {
	let { config: t } = e, n = t.render_mode === "canvas" ? Si(e) : null;
...
var wi = class {
	...
	constructor(e) {
		let t = this;
		t.api = e, t.config = new cn(), t.cache = new dn();
		let n = new un();
	...
	beforeInit() {
		let e = this;
		e.callPluginHook("$beforeInit"), B(e.config.onbeforeinit, e.api);
	}
	afterInit() {
		let e = this;
		e.callPluginHook("$afterInit"), B(e.config.onafterinit, e.api);
	}
	init() {
		let e = this, { config: t, state: n, $el: r } = e, { boost_useCssRule: i, bindto: a } = t;
		mt(e), Ci(e);
		let s = e.hasArcType();
		if (n.hasRadar = !n.hasAxis && e.hasType("radar"), n.hasFunnel = !n.hasAxis && e.hasType("funnel"), n.hasTreemap = !n.hasAxis && e.hasType("treemap"), n.hasAxis = !s && !n.hasFunnel && !n.hasTreemap, n.datetimeId = `bb-${+/* @__PURE__ */ new Date() * rt()}`, i) {
		...
		z(a) && (c.element = a.element || "#chart", c.classname = a.classname || c.classname), r.chart = j(c.element.node) ? a.element : o(c.element || []), r.chart.empty() && (r.chart = o(k.body.appendChild(k.createElement("div")))), r.chart.html("").classed(c.classname, !0).classed(n.datetimeId, i).style("position", "relative"), e.initParams(), e.initToRender();
	}
	initToRender(e) {
	...
	initParams() {
		...
		if (t.render_mode === "canvas" && e.prepareCanvasConfig?.(), e.color = e.generateColor(), e.levelColor = e.generateLevelColor(), t.padding === !1 && (t.axis_x_show = !1, t.axis_y_show = !1, t.axis_y2_show = !1, t.subchart_show = !1), t.render_mode !== "canvas" && (e.hasPointType() || e.hasLegendDefsPoint?.()) && (e.point = e.generatePoint()), r.hasAxis) {
			e.initClip(), n.extraLineClasses = e.generateExtraLineClass(), n.dataTime = t.data_xLocaltime ? p : h, n.axisTime = t.axis_x_localtime ? g : f;
	...
	initWithData(e) {
		...
		if (s && (t.axis = t.getAxisInstance(), n.zoom_enabled && t.initZoom()), t.data.xs = {}, t.data.targets = t.convertDataToTargets(e), n.data_filter && (t.data.targets = t.data.targets.filter(n.data_filter.bind(t.api))), n.data_hide && t.addHiddenTargetIds(n.data_hide === !0 ? t.mapToIds(t.data.targets) : n.data_hide), n.legend_hide && t.addHiddenLegendIds(n.legend_hide === !0 ? t.mapToIds(t.data.targets) : n.legend_hide), t.updateSizes(), t.updateScales(!0), s) {
			...
			e && (e.domain(et(t.getXDomain(t.data.targets), !n.axis_x_inverted)), s.domain(e.domain()), o.xDomain = e.domain()), i && (i.domain(t.getYDomain(t.data.targets, "y")), c.domain(i.domain())), a && (a.domain(t.getYDomain(t.data.targets, "y2")), l && l.domain(a.domain()));
		}
		if (n.render_mode === "canvas") {
			if (!t.initCanvas) throw Error("[billboard.js] Please import and call canvas() to use render.mode='canvas'.");
			if (t.bindResize(), t.initCanvas(), n.tooltip_show && t.initTooltip(), t.callPluginHook("$init"), B(n.oninit, t.api), t.redraw({
				withTransition: !1,
				withTransform: !0,
				withUpdateXDomain: !0,
				withUpdateOrgXDomain: !0,
				...
				B(n.data_onmin, t.api, e.min), B(n.data_onmax, t.api, e.max);
			}
			i.rendered = !0;
			return;
		}
		if (a.svg = a.chart.append("svg").style("overflow", "hidden").style("display", "block"), u && i.inputType) {
			let e = i.inputType === "touch", { onclick: r, onover: o, onout: s } = n, c = n.interaction_inputType_touch?.preventDefault, l = me(c) && c || !1, u = e ? { passive: !l && (!isNaN(c) && c || null) === null } : void 0;
		...
		let m = a.svg.append("g").classed(W.main, !0).attr("transform", c || l ? null : t.getTranslate("main"));
		if (a.main = m, n.subchart_show && t.initSubchart(), n.tooltip_show && t.initTooltip(), n.title_text && t.initTitle(), !l && n.legend_show && t.initLegend(), n.data_empty_label_text && m.append("text").attr("class", `${Z.text} ${W.empty}`).attr("text-anchor", "middle").attr("dominant-baseline", "middle"), s && (n.regions.length && t.initRegion?.(), !n.clipPath && t.axis.init()), m.append("g").classed(W.chart, !0).attr("clip-path", s ? i.clip.path : null), t.callPluginHook("$init"), t.initChartElements(), s && (u && t.initEventRect?.(), t.initGrid?.(), n.clipPath && t.axis?.init()), t.updateTargets(t.data.targets), t.updateDimension(), B(n.oninit, t.api), t.setBackground(), t.redraw({
			withTransition: !1,
			withTransform: !0,
			withUpdateXDomain: !0,
			withUpdateOrgXDomain: !0,
	...
	initChartElements() {
		...
		L(e.config.data_labels) && !e.hasArcType(null, ["radar"]) && e.initText();
	}
	setChartElements() {
	...
	filterTargetsToShowAtInit(e = !1) {
		let t = this, { $el: { svg: n }, $T: r } = t, i = `.${W.target}`;
		e && (i += `, .${Rt.chartCircles} > .${Rt.circles}`), r(n.selectAll(i).filter((e) => t.isTargetToShow(e.id))).style("opacity", null);
	}
	getWithOption(e) {
		let t = {
			Dimension: !0,
	...
	bindResize() {
		let e = this, { $el: t, config: n, state: r } = e, { resize_auto: i, resize_live: a } = n, o = /^(true|parent)$/.test(i), s = [], c = () => {
			let t = r.current.width, i = r.current.height;
			return e.setContainerSize(), !r.resizePreview && t === r.current.width && i === r.current.height ? !1 : (r.resizing = !0, r.dirty.size = !0, n.legend_show && (e.updateSizes(), r.isCanvasMode ? e.updateHtmlLegend?.() : e.updateLegend()), e.api.flush(!1), !0);
		}, l = mn(n.resize_timer, o && a ? () => {
			if (r.resizeLiveScale === null && (r.resizeLiveScale = r.resizeRedrawTime > 16), r.resizeLiveScale) {
				e.previewResize();
				return;
			}
			let t = xi();
			c() && (r.resizeRedrawTime = xi() - t, r.resizeLiveScale = r.resizeRedrawTime > 16);
		} : void 0);
		s.push(() => B(n.onresize, e.api)), o && s.push(c), s.push(() => {
			B(n.onresized, e.api), r.resizing = !1, r.resizeLiveScale = null;
		}), s.forEach((e) => l.add(e)), e.resizeFunction = l, i === "parent" && O.ResizeObserver ? (e.resizeFunction.resizeObserver = new O.ResizeObserver(e.resizeFunction.bind(e))).observe(t.chart.node().parentNode) : (i === "parent" && O.console?.warn?.("[billboard.js] resize.auto='parent' requires ResizeObserver; falling back to window resize."), O.addEventListener("resize", e.resizeFunction));
	}
	callPluginHook(e, ...t) {
...
var Ei = {
	...
	config(e, t, n) {
		...
		return e && a in r ? F(t) ? (r[a] = t, o = t, n && this.flush()) : o = r[a] : (arguments.length === 0 || ye(e)) && (o = i.orgConfig), o;
	}
}, Di = { color(e) {
...
Xe(Oi, {
	...
	values: function(e, t = !0) {
		...
		if (e) {
			let r = this.data(e);
			R(r) && (n = [], r.forEach((e) => {
				t ? e.values.forEach((e) => n.push(e.value)) : n.push(e.values.map((e) => e.value));
			}));
		}
		return n;
	},
...
var ki = { data: Oi }, Ai = {
	focus(e) {
		...
		this.revert(), this.defocus(), i.classed(J.focused, !0).classed(J.defocused, !1), t.hasArcType() && !n.hasRadar && (t.expandArc(r), t.hasType("gauge") && t.markOverlapped(e, t, `.${Ht.gaugeValue}`)), t.toggleFocusLegend(r, !0), n.focusedTargetIds = new Set(r), r.forEach((e) => n.defocusedTargetIds.delete(e));
	},
	defocus(e) {
		let t = this.internal, { state: n } = t, r = t.mapToTargetIds(e);
		if (n.isCanvasMode) {
		...
		t.$el.svg.selectAll(t.selectorTargets(r.filter(t.isTargetToShow, t))).classed(J.focused, !1).classed(J.defocused, !0), t.hasArcType(null, ["polar"]) && (t.unexpandArc(r), t.hasType("gauge") && t.undoMarkOverlapped(t, `.${Ht.gaugeValue}`)), t.toggleFocusLegend(r, !1), r.forEach((e) => n.focusedTargetIds.delete(e)), n.defocusedTargetIds = new Set(r);
	},
	revert(e) {
		let t = this.internal, { config: n, state: r, $el: i } = t, a = t.mapToTargetIds(e), s = () => {
			n.legend_show && (t.showLegend(a.filter(t.isLegendToShow.bind(t))), i.legend.selectAll(t.selectorLegends(a)).filter(function() {
				return o(this).classed(J.legendItemFocused);
		...
		i.svg.selectAll(t.selectorTargets(a)).classed(J.focused, !1).classed(J.defocused, !1), t.hasArcType(null, ["polar"]) && t.unexpandArc(a), s(), r.focusedTargetIds = /* @__PURE__ */ new Set(), r.defocusedTargetIds = /* @__PURE__ */ new Set();
	}
}, ji = { legend: {
	show: function(e) {
		let t = this.internal;
	...
	load(e) {
		...
		if ("regions" in e && !r && !i) {
			t.redraw({
				...
				withUpdateXDomain: !0,
				withLegend: !0
			}), or.call(t, e.done, e.resizeAfter);
			return;
		}
		if (i) {
			let n = t.mapToTargetIds(e.unload === !0 ? null : e.unload);
			t.unload(n, () => {
				t.config && t.cache && (t.cache.remove(n), fe(() => t.loadFromArgs(e)));
			});
		} else t.loadFromArgs(e);
	},
	unload(e) {
		let t = this.internal, n = e || {};
		ye(n) && this.tooltip.hide(), R(n) ? n = { ids: n } : M(n) && (n = { ids: [n] });
		...
		t.state.dirty.data = !0, t.state._eventRectFingerprint = null, t.unload(r, () => {
			t.config && t.cache && (t.redraw({
				...
				withUpdateXDomain: !0,
				withLegend: !0
			}), t.cache.remove(r), or.call(t, n.done, n.resizeAfter));
		});
	}
};
//#endregion
...
function Ni(e, t, n, r = !1) {
	...
	if (i.state.toggling = !0, i.state.dirty.visibility = !0, i[`${e ? "remove" : "add"}HiddenTargetIds`](a), i.state.isCanvasMode) {
		e && s.length ? B(i.config.data_onshown, this, s) : !e && s.length === 0 && B(i.config?.data_onhidden, this, a), r || i.redraw({
			withUpdateOrgXDomain: !0,
			withUpdateXDomain: !0,
			withLegend: !0
		}), i.state.toggling = !1;
	...
	e && s.length && (c.style("display", null), B(i.config.data_onshown, this, s)), i.$T(c).style("opacity", l, "important").call(Ke, () => {
		!e && s.length === 0 && (c.style("display", "none"), B(i.config?.data_onhidden, this, a)), c.style("opacity", l);
...
var Pi = {
	...
	toggle(e, t = {}) {
		...
		n.mapToTargetIds(e).forEach((e) => r[n.isTargetToShow(e) ? "hide" : "show"].push(e)), r.show.length && r.hide.length ? (Ni.call(this, !0, r.show, t, !0), Ni.call(this, !1, r.hide, t)) : (r.show.length && this.show(r.show, t), r.hide.length && this.hide(r.hide, t));
	}
}, Fi = { tooltip: {
	show: function(e) {
		...
		if (e.mouse && (l = e.mouse), e.data) {
			...
			if ((a || o) && s.id) {
				let e = t.selectorTarget(s.id, void 0, `.${X.shape}`);
	...
	constructor(t) {
		...
		this.internal = n, (function e(t, n, r) {
			Object.keys(t).forEach((i) => {
				let a = j(t[i]), o = n !== r, s = L(t[i]), c = s && Object.keys(t[i]).length > 0;
				n[i] = a && (!o && c || o) ? t[i].bind(r) : s && !a ? {} : t[i], c && e(t[i], n[i], r);
			});
		})(e.prototype, this, this), Ti.call(n, t), n.beforeInit(), n.init();
	}
};
Xe(Ii.prototype, [
	Ei,
...
function Ri(e, t) {
	...
	}, a = new DOMParser().parseFromString(He(e), "image/svg+xml").documentElement, s = k.createElementNS(r.svg, a.nodeName.toLowerCase());
	if (s.id = t, s.style.fill = "inherit", s.style.stroke = "inherit", i(a, s), a.childNodes?.length) {
		let e = o(s);
		"innerHTML" in s ? e.html(He(a.innerHTML)) : Je(a.childNodes).forEach((t) => {
...
var zi = {
	...
	getValidPointPattern() {
		...
		return L(e.point_pattern) ? e.point_pattern : [t];
	},
	generatePoint() {
		...
		return function(a, s, ...c) {
			return function(l) {
				...
				else if (!Li(f || n.point_type)) {
					let n = e.getDefsPointId(u);
					if (t.defs.select(`#${n}`).size() < 1 && Ri.call(e, f, n), a === "create") return e.custom?.create.bind(s)(d, n, ...c);
...
var Ui = { axis: {
	...
	min: function(e) {
		let t = this.internal;
		return A(e) || e === !1 ? Vi(t, "min", e) : Hi(t, "min");
	},
	max: function(e) {
		let t = this.internal;
		return A(e) || e === !1 ? Vi(t, "max", e) : Hi(t, "max");
	},
	range: function(e) {
		let { axis: t } = this;
		if (arguments.length) {
	...
	x(e) {
		...
		return R(e) && (i ? this.categories(e) : (t.updateTargetX(r.targets, e), t.state.dirty.data = !0, t.redraw({
			withUpdateOrgXDomain: !0,
			withUpdateXDomain: !0
	...
	xs(e) {
		let t = this.internal;
		return z(e) && (t.updateTargetXs(t.data.targets, e), t.state.dirty.data = !0, t.redraw({
			withUpdateOrgXDomain: !0,
			withUpdateXDomain: !0
		})), t.data.xs;
	}
	...
	getSizeFor1Char(e, t, n = !0) {
		...
		return this.charSize[e] && n ? this.charSize[e] : (!t.empty() && t.text("0").call((e) => {
			try {
				let { width: t, height: n } = wt(e.node(), !0);
				t && n && (r.w = t, r.h = n);
			} finally {
				e.text("");
			}
	...
	generateTicks(e, t) {
		...
		if (t && n) {
			...
			if (e.type === "log" && !t) {
				let t = Vr("_log").domain([r > 0 ? r : 1, i]).range(e.range());
				a = t.ticks();
...
//#endregion
//#region node_modules/billboard.js/dist-esm/ChartInternal/Axis/AxisRenderer.js
function qi(e) {
	return e === "subX" ? "x" : e === "subY" ? "y" : e === "subY2" ? "y2" : e;
}
function Ji(e) {
	let t = qi(e);
	return /^sub/.test(e) ? `subchart_axis_${t}` : `axis_${t}`;
}
var Yi = class {
	helper;
	config;
	...
	canReuseTickTextOnResize(e) {
		let { config: t, params: n } = this, { config: r, id: i, owner: a } = n, o = /^(x|subX)$/.test(i), s = qi(i), c = /^sub/.test(i) && r[`subchart_axis_${s}_tick_format`] || r[`axis_${s}_tick_format`], l = n.tickMultiline && n.isCategory && !e && !(n.tickWidth > 0);
		return !(!a.state.resizing || a.state.flowing || j(r.axis_evalTextSize) || c || n.tickTitle || o && r.axis_x_tick_autorotate || l || !t.withoutTransition);
	}
	...
	constructor(e = {}) {
		...
		t.tickLength = Math.max(t.innerTickSize, 0) + t.tickPadding, this.config = t, this.params = e, this.helper = new Ki(this);
	}
	create(e) {
		...
		let { innerTickSize: h, tickLength: g, range: _ } = n, v = i.id, y = qi(v), { isSubAxes: b } = i, x = !b && y && /^(x|y|y2)$/.test(y) ? i.config[`axis_${y}_tick_text_position`] : {
			x: 0,
			y: 0
		}, S = Ji(v), C = i.config[`${S}_show`], w = b ? {
			tick: !0,
			text: !0
		} : {
			tick: C ? i.config[`${S}_tick_show`] : !1,
			text: C ? i.config[`${S}_tick_text_show`] : !1
		}, T = i.config.axis_evalTextSize, E;
		e.each(function() {
			let e = o(this), y = this.__chart__ || a, b = r.copyScale();
			E = e, this.__chart__ = b, n.tickOffset = i.isCategory ? (b(1) - b(0)) / 2 : 0;
			let S = e.selectAll(".domain").data([0]);
			if (S.enter().append("path").attr("class", "domain").merge(S).attr("d", () => {
				let e = n.outerTickSize * p;
				return u ? `M${_[0]},${e}V0H${_[1]}V${e}` : `M${e},${_[0]}H0V${_[1]}H${e}`;
			}), w.tick || w.text) {
				let a = n.tickValues || r.generateTicks(b, l || i.config.axis_rotated);
				t.generatedTicks = a;
				let o = e.selectAll(".tick");
				if (t.canReuseTickNodesOnResize(o, a, l || i.config.axis_rotated, w)) d(o, b);
				else {
					o = o.data(a, b);
					let e = o.enter().insert("g", ".domain").attr("class", "tick"), n = o.exit().remove();
					o = e.merge(o), w.tick && e.append("line"), w.text && e.append("text");
					let _ = !e.empty() || !n.empty(), S = w.text && !_ && t.canReuseTickTextOnResize(l || i.config.axis_rotated), C = {
						w: 0,
						h: 0
					}, E = o.selectAll("text.__bb-empty");
					if (w.text && !S) {
						let e = o.select("text"), n = [];
						E = e, j(T) && (C = T.bind(t.params.owner.api)(e.node(), v), this.classList.contains(W.dummy) && (this.sizeFor1Char = C)), (!C || C.w === 0 || C.h === 0) && (C = t.helper.getSizeFor1Char(s, e, !!T));
						let d = e.selectAll("tspan").data((e, t) => {
							let o;
							if (i.tickMultiline) o = c(e, b, a, l, C.w);
							else {
						...
						d.exit().remove(), d = d.enter().append("tspan").merge(d).text((e) => e.splitted), d.attr("x", u ? 0 : g * p).attr("dx", (() => {
							let e = 0;
							return /(top|bottom)/.test(s) && m && (e = 8 * Math.sin(m / 180 * Math.PI) * (s === "top" ? -1 : 1)), e + (x.x || 0);
						})()).attr("dy", (e, t) => {
							let r = ".71em", i = 0;
							return s !== "top" && (i = C.h, t === 0 && (i = l ? -((n[e.index] - 1) * (C.h / 2) - 3) : x.y === 0 ? r : 0)), N(i) && x.y ? i + x.y : i || r;
						});
					}
					let D = o.select("line");
					if (e.select("line").attr(`${f}2`, h * p), e.select("text").attr(f, g * p), t.setTickLineTextPosition(D, E, C), i.tickTitle) {
						let e = E.select("title"), t = i.tickTitle;
						(e.empty() ? E.append("title") : e).text((e) => t[Number(e)]);
					}
					if (b.bandwidth) {
						let e = b, t = e.bandwidth() / 2;
						y = (n) => e(n) + t, b = y;
					} else y.bandwidth ? y = b : d(n, b);
					o = i.owner.state.flowing ? r.transitionise(o) : i.owner.$T(o), d(e, y), d(o.style("opacity", null), b);
				}
			}
		}), this.g = E;
	}
	...
	setTickLineTextPosition(e, t, n) {
		...
		}, { config: { axis_rotated: m, axis_x_tick_text_inner: h } } = this.params.owner, g = this.params.config[`axis_${qi(c)}_tick_inner`];
		switch (a) {
			case "bottom":
	...
	ticks(...e) {
		let { config: t } = this;
		return e.length ? (t.tickArguments = Je(e), this) : t.tickArguments;
	}
	tickCulling(e) {
		let { config: t } = this;
...
function Qi(e, t, n) {
	let r = Xi(t), i = e[`subchart_axis_${r}_tick_${n}`];
	return Zi(t) && i !== void 0 ? i : e[`axis_${r}_tick_${n}`];
}
function $i(e) {
...
function aa(e) {
	return j(e) ? ha(e) : !Array.isArray(e) || e.length <= ea ? e : {
		length: e.length,
		first: e[0],
...
function sa(e, t) {
	N(t) ? Object.defineProperty(e, ta, {
		configurable: !0,
		value: t,
		writable: !0
	}) : delete e[ta];
...
var ba = { getAxisInstance: function() {
	...
	isCustomX() {
		...
		return !this.isTimeSeries() && (e.data_x || L(e.data_xs));
	}
	isTimeSeries(e = "x") {
	...
	setOrient() {
		...
		this.orient = {
			...
			subX: e ? "left" : "bottom",
			subY: e ? t ? "top" : "bottom" : t ? "right" : "left",
			subY2: e ? n ? "bottom" : "top" : n ? "left" : "right"
		};
	}
	generateAxes(e) {
		let t = this.owner, { config: n } = t, r = [], i = n[`axis_${e}_axes`], a = n.axis_rotated, o;
		e === "x" ? o = a ? "left" : "bottom" : e === "y" ? o = a ? "bottom" : "left" : e === "y2" && (o = a ? "top" : "right"), i.length && i.forEach((i) => {
			let a = i.tick || {}, s = t.scale[e].copy();
			...
			let c = new Yi({
				...
				isSubAxes: !0,
				owner: t
			}).scale(s).orient(o).tickFormat(j(a.format) ? a.format.bind(t.api) : ((e) => e));
			A(a.count) && c.ticks(a.count), a.values && c.tickValues(a.values), r.push(c);
		}), this.axesList[e] = r;
	}
	updateAxes() {
		...
		Object.keys(this.axesList).forEach((i) => {
			...
			this.axesList[i].forEach((c, l) => {
				...
				f.empty() ? (f = n.append("g").attr("class", d).style("visibility", t[`axis_${i}_show`] ? null : "hidden"), c.create(f)) : (a[l].domain && o.domain(a[l].domain), c.scale(o).create(r(f))), f.attr("transform", e.getTranslate(i, l + 1));
			});
		});
	}
	setAxis(e, t, n, r) {
		let i = this.owner, a = Xi(e);
		Zi(e) || (this.tick[a] = this.getTickValues(a)), this[e] = this.getAxis(e, t, n, e === "x" && (i.scale.zoom || i.config.subchart_show || i.state.resizing) ? !0 : r);
	}
	getAxis(e, t, n, r, i) {
		let a = this.owner, { config: o } = a, s = /^(x|subX)$/.test(e), c = Xi(e), l = s && this.isCategorized(), u = this.orient[e], d = i ? 0 : a.getAxisTickRotate(c), f;
		if (s) f = e === "subX" ? a.format.subXAxisTick : a.format.xAxisTick;
		else {
			let t = Zi(e) && o[`subchart_axis_${c}_tick_format`] || o[`axis_${c}_tick_format`];
			j(t) && (f = t.bind(a.api));
		}
		let p = Zi(e) ? this.getTickValues(c, !0) : this.tick[c], m = $e({
			outerTick: n,
			noTransition: r,
			config: o,
			id: e,
		...
		let h = new Yi(m).scale(s && a.scale.zoom || t).orient(u);
		if (s && this.isTimeSeries() && p && !j(p)) {
			let e = ot.bind(a);
			p = p.map((t) => e(t));
		} else !s && this.isTimeSeriesY() && (h.ticks(o.axis_y_tick_time_value), p = null);
		p && h.tickValues(p), h.tickFormat(f || !s && a.isStackNormalized() && a.hasAxisGroupedData(c) && ((e) => `${e}%`)), l && (h.tickCentered(o.axis_x_tick_centered), ye(o.axis_x_tick_culling) && (o.axis_x_tick_culling = !1));
		let g = Qi(o, e, "count");
		return g && h.ticks(g), h;
	}
	updateXAxisTickValues(e, t) {
		let n = this.owner, { config: r } = n, i = r.axis_x_tick_fit, a = (t = r.axis_x_tick_count) => {
			let a = t, o;
			return i && (o = n.mapTargetsToUniqueXs(e), this.isCategorized() && a > o.length && (a = o.length), o = this.generateTickValues(o, a, this.isTimeSeries())), o;
		}, o = a();
		if (t) t.tickValues(o);
		else if (this.x) {
			let e = this.getTickValues("x", !0), t = Qi(r, "subX", "count"), n = e ?? (t === r.axis_x_tick_count ? o : a(t));
			this.x.tickValues(o), this.subX?.tickValues(n);
		}
		return o;
	}
	getId(e) {
	...
	getTickValues(e, t = !1) {
		let n = this.owner, r = t ? Qi(n.config, `sub${V(e)}`, "values") : n.config[`axis_${e}_tick_values`], i = j(r) ? r.call(n.api) : r, a = n[`${e}Axis`];
		return t ? i ?? void 0 : i || (a ? a.tickValues() : void 0);
	}
	...
	getMaxTickSize(e, t) {
		let n = this.owner, { config: r, state: i, $el: { svg: a, chart: o } } = n, { current: s, resizing: c } = i, l = s.maxTickSize[e], u = `${$.maxTickSize}_${e}_${!!t}`, d = n.cache.get(u);
		...
		if ((a || r.render_mode === "canvas") && n.scale[e]?.copy) {
			let a = /^y2?$/.test(e), s = n.getTargetsToShow(), c = n.scale[e].copy().domain(n[`get${a ? "Y" : "X"}Domain`](s, e)), h = c.domain(), g = h[0] === h[1] && h.every((e) => e > 0), _ = R(l.domain) && l.domain[0] === l.domain[1] && l.domain.every((e) => e > 0);
			if (g || _) return l;
			...
			let C = o.append("svg").style("visibility", "hidden").style("position", "fixed").style("top", "0").style("left", "0"), w = C.append("g").attr("class", `${G[`axis${V(e)}`]} ${W.dummy}`);
			v.create(w);
			...
			if (T) E.each(function(e, t) {
				...
				if (E.each(function() {
					e.push(this);
				}), (e.length <= 5 ? e : $i(e)).map((e) => U(e, !0)).forEach((e) => {
	...
	getXAxisTickTextY2Overflow(e) {
		...
		if ((n.isCategorized() || n.isTimeSeries()) && r.axis_x_tick_fit && (!r.axis_x_tick_culling || ye(r.axis_x_tick_culling)) && !r.axis_x_tick_multiline && c) {
	...
	getXAxisTickMaxOverflow(e, t) {
		...
		if (!o && i.axis_x_tick_count <= m.length && m[0].values.length) {
			let e = Vr(n.axis.getAxisType("x"), 0, t - f).domain([u * -1, n.getXDomainMax(n.data.targets) + 1 + d]);
			h = (e(1) - e(0)) / 2;
		}
		return f + h;
	}
	updateLabels(e) {
		...
		[
			...
			let a = this.getLabelText(t), o = `axis${V(t)}`, s = G[`${o}Label`];
			if (a) {
				let c = n.select(`text.${s}`);
				c.empty() && (c = n.select(`g.${G[o]}`).insert("text", ":first-child").attr("class", s).attr("transform", ["rotate(-90)", null][t === "x" ? +!i : +i]).style("text-anchor", () => this.textAnchorForAxisLabel(t))), r(c, e).attr("x", () => this.xForAxisLabel(t)).attr("dx", () => this.dxForAxisLabel(t)).attr("dy", () => this.dyForAxisLabel(t)).text(a);
			}
		});
	}
	getPadding(e, t, n, r) {
	...
	generateTransitions(e) {
		let { $el: { axis: t }, $T: n } = this.owner, [r, i, a, o, s, c] = [
			"x",
			"y",
			"y2",
			"subX",
	...
	redraw(e, t, n) {
		...
		[
			...
			i && s && (!n && !r.transition_duration && (i.config.withoutTransition = !0), s.style("opacity", o), i.create(e[`axis${V(t)}`]));
	...
	syncAxisDomains(e, t, n) {
		...
		if (!s && this.isCategorized() && e.length === 0 && o.axis.x && a.x.domain([0, o.axis.x.selectAll(".tick").size()]), a.x && e.length ? (!s && r.updateXDomain(e, t.UpdateXDomain, t.UpdateOrgXDomain, t.TrimXDomain), i.axis_x_tick_values || this.updateXAxisTickValues(e)) : this.x && (this.x.tickValues([]), this.subX?.tickValues([])), i.zoom_rescale && !n && (c = a.x.orgDomain()), ["y", "y2"].forEach((t) => {
			...
			let t = () => {
				a.subY?.domain(r.getYDomain(e, "y")), a.subY2?.domain(r.getYDomain(e, "y2")), ["y", "y2"].forEach((e) => {
					let t = e === "y2" ? "subY2" : "subY", n = a[t], o = r.axis[t], s = this.getTickValues(e, !0), c = Qi(i, t, "count");
					if (!n || !o || s || !c) return;
					let l = n.domain();
					o.tickValues(this.generateTickValues(l, l.every((e) => e === 0) ? 1 : c, this.isTimeSeriesY()));
				});
			};
			i.subchart_show ? r.withSubchartTypeContext(t) : t();
		}
	}
	...
	setCulling() {
		...
		[
			...
			let a = r.axis[i], o = Qi(e, i, "culling");
			if (a && o) {
				let o = a.selectAll(".tick"), s = et(o.data(), !Qi(e, i, "culling_reverse")), c = s.length, l = Qi(e, i, "culling_max"), u = !Qi(e, i, "culling_lines") || ra(this[i], s, na(o)), d;
				if (c) {
					for (let e = 1; e < c; e++) if (c / e < l) {
						d = e;
						break;
					}
					d ??= c;
					let e = /* @__PURE__ */ new Map();
					for (let t = 0; t < s.length; t++) e.set(s[t], t);
					o.each(function(t) {
						let n = u ? this : this.querySelector("text");
						n && (n.style.display = (e.get(t) ?? 0) % d ? "none" : null);
					});
				} else o.style("display", null);
				if (i === "x") {
					let e = n.maxTickSize.x.clipPath ? t.pathXAxisTickTexts : null;
					r.svg.selectAll(`.${G.axisX} .tick text`).attr("clip-path", e);
				}
			}
		});
	}
	setAxisTooltip() {
		...
		e.generateTextBGColorFilter(a, {
			...
			(M(a) || a[n]) && (i[n] = r[n]?.append("text").classed(G[`axis${n.toUpperCase()}Tooltip`], !0).attr("filter", e.updateTextBGColor({ id: n }, a)), t ? i[n]?.attr(n === "x" ? "x" : "y", n === "y" ? "1.15em" : n === "x" ? "-0.3em" : "-0.4em").attr(`d${n === "x" ? "y" : "x"}`, n === "x" ? "0.4em" : "-1.3em").style("text-anchor", n === "x" ? "end" : null) : i[n]?.attr(n === "x" ? "y" : "x", n === "x" ? "1.15em" : `${n === "y" ? "-" : ""}0.4em`).attr(`d${n === "x" ? "x" : "y"}`, n === "x" ? "-1em" : "0.3em").style("text-anchor", n === "y" ? "end" : null));
		});
	}
}, Sa = {
	initEventRect() {
		this.$el.main.select(`.${W.chart}`).append("g").attr("class", Wt.eventRects).style("fill-opacity", "0");
	},
	redrawEventRect() {
		...
		if (r.eventRect) e.updateEventRect(r.eventRect, !0);
			...
			let a = e.$el.main.select(`.${Wt.eventRects}`).style("cursor", t.zoom_enabled && t.zoom_type !== "drag" ? t.axis_rotated ? "ns-resize" : "ew-resize" : null).classed(Wt.eventRectsMultiple, i).classed(Wt.eventRectsSingle, !i).selectAll(`.${Wt.eventRect}`).data([0]).enter().append("rect");
	...
	bindTouchOnEventRect() {
		...
		}, s = t.interaction_inputType_touch.preventDefault, c = me(s) && s || !1, l = !isNaN(s) && s || null, u, d = !c && l === null, f = (e) => {
		...
		r.on("touchstart", (t) => {
			...
			if (n.event = t, !r.empty() && r.classed(Wt.eventRect)) {
				if (n.dragging || n.flowing || e.hasArcType() || t.touches.length > 1) return;
				f(t), a(r.node());
			} else o();
		}, { passive: d }).on("touchend.eventRect", (t) => {
			n.event = t, !r.empty() && r.classed(Wt.eventRect) && (e.hasArcType() || !e.toggleShape || n.cancelClick) && (n.cancelClick &&= !1);
	...
	updateEventRect(e, t = !1) {
		...
		(!s || c || t) && (l.attr("x", 0).attr("y", 0).attr("width", a).attr("height", o), (!s || t) && l.classed(Wt.eventRect, !0)), (() => {
			if (i) {
				let e = Et(r.chart.node());
				i.rect = U(l.node(), !0).toJSON(), i.rect.top += e.y, i.rect.left += e.x;
			}
		})();
	},
	updateEventType(e) {
		let t = this, n = me(e), r = n ? t.$el.eventRect : e, i = n ? e !== r?.datum().multipleX : !1;
	...
	selectRectForSingle(e, t) {
		...
		if (u && (n.showTooltip(d, e), n.showGridFocus?.(d), n.showSubchartGridFocus?.(d), !s || c)) return;
		!o && a.selectAll(`.${W.EXPANDED}:not(.${X.shape}-${t})`).classed(W.EXPANDED, !1);
		let f = a.selectAll(`.${X.shape}-${t}`).classed(W.EXPANDED, !0).style("cursor", l ? "pointer" : null).filter(function(e) {
			return n.isWithinShape(this, e);
		});
		if (f.call((r) => {
			let i = r.data();
			s && (c || l?.bind(n.api)(i)) && (e.style.cursor = "pointer"), u || (n.showTooltip(i, e), n.showGridFocus?.(i), n.showSubchartGridFocus?.(i), n.unexpandCircles?.(), r.each((e) => n.setExpand(t, e.id)));
		}), !u && f.empty()) {
			let a = Ct(i.event, e), o = d.filter((e) => n.isTargetToShow(e.id) ? n.dist(e, a) < n.getPointSensitivity(e) : !1);
			if (o.length > 0) {
				...
				n.showTooltip([r], e), n.showGridFocus?.([r]), n.showSubchartGridFocus?.([r]), n.unexpandCircles?.(), n.setExpand(t, r.id, !0), s && (c || l?.bind(n.api)(r)) && (e.style.cursor = "pointer");
			} else r.interaction_onout && (n.hideGridFocus?.(), n.hideSubchartGridFocus?.(), n.hideTooltip(), !c && n.setExpand(t));
		}
	},
	selectRectForMultipleXs(e, t = !0) {
		let n = this, { config: r, state: i } = n, a = n.getTargetsToShow();
		if (i.dragging || n.hasArcType(a)) return;
		let o = Ct(i.event, e), s = n.findClosestFromTargets(a, o);
		...
		n.showTooltip(c, e), n.setExpand(s.index, s.id, !0), n.showGridFocus?.(c), n.showSubchartGridFocus?.(c);
		let l = n.dist(s, o);
	...
	unselectRect() {
		...
		e.$el.eventRect?.style("cursor", null), e.hideGridFocus?.(), e.hideSubchartGridFocus?.(), r && (e.hideTooltip(), e._handleLinkedCharts(!1)), n && !e.isPointFocusOnly() && e.unexpandCircles(), e.expandBarTypeShapes(!1);
	},
		...
		if (r.inputType === "mouse") {
			...
			a.on("mouseover", (e) => {
				...
				if (n.line_step_tooltipMatch && t.hasType("step") && /^step\-(before|after)$/.test(c)) {
					let e = t.scale.zoom || t.scale.x, n = t.axis.xs[s], r = e.invert(Ct(a, this)[0]);
				...
				if (r.dragging || r.flowing || t.hasArcType() || l) {
					if (n.tooltip_show && l) {
						let [e, n] = Ct(a, this), i = r._lastTooltipMouse;
	...
	clickHandlerForSingleX(e, t) {
		...
		let { index: o } = e;
		a.selectAll(`.${X.shape}-${o}`).each(function(e) {
	...
	clickHandlerForMultipleXS(e) {
		...
		let a = Ct(r.event, this), o = t.findClosestFromTargets(i, a);
		if (!o) return;
		let s = t.getPointSensitivity(o);
		(t.isBarType(o.id) || t.dist(o, a) < s) && t.$el.main.selectAll(`.${X.shapes}${t.getTargetSelectorSuffix(o.id)}`).selectAll(`.${X.shape}-${o.index}`).each(function() {
	...
	needToRotateXAxisTickTexts() {
		let e = this, { state: { axis: t, current: n, isLegendRight: r, legendItemWidth: i } } = e, a = n.width - (r && i) - e.getCurrentPaddingByDirection("left") - e.getCurrentPaddingByDirection("right"), o = t.x.tickCount + t.x.padding.left + t.x.padding.right, { width: s } = e.axis.getMaxTickSize("x");
		return s > (o ? a / o : 0);
	}
}, Ta = {
	axis_x_clipPath: !0,
...
function Pa(e = [], t = []) {
	Xe(wi.prototype, Na(ja).concat(e)), Xe(Ii.prototype, Aa), cn.setOptions(Na(Ma).concat(t));
}
//#endregion
...
var Ia = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, La = /([aAcChHlLmMqQsStTvVzZ])|([-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?)/g;
function Ra(e) {
	let t = /* @__PURE__ */ new Set(), n = -1, r = 0, i = !1, a;
	for (La.lastIndex = 0; a = La.exec(e);) if (a[1]) i = a[1] === "a" || a[1] === "A", r = 0;
	else if (n++, i) {
		let e = r % 7;
		(e === 2 || e === 3 || e === 4) && t.add(n), r++;
	}
	return t;
}
function za(e, t) {
	let n = Ra(t), r = [], i = [], a = 0, o = -1, s = -1, c, l, u = (e) => {
		r[o] ? r[o] += e : r[++o] = e;
	};
	Ia.lastIndex = 0;
	let d = Ia, f = new RegExp(Ia.source, "g");
	for (e += "", t += ""; (c = d.exec(e)) && (l = f.exec(t));) {
		if (s++, l.index > a && u(t.slice(a, l.index)), c[0] === l[0]) u(l[0]);
		else {
			let e = +c[0], t = +l[0], a = n.has(s);
			r[++o] = null, i.push({
				index: o,
				fn: a ? (n) => Math.round(e + (t - e) * n) : (n) => e + (t - e) * n
			});
		}
		a = f.lastIndex;
	}
	if (a < t.length && u(t.slice(a)), !i.length) {
		let e = r.join("");
		return () => e;
	}
	return (e) => {
		for (let t = 0, n = i.length; t < n; t++) {
			let { index: n, fn: a } = i[t];
			r[n] = String(a(e));
		}
		return r.join("");
	};
...
var Ka = {
	initBar() {
		...
		e.bar = e.main.select(`.${W.chart}`), e.bar = t.bar_front ? e.bar.append("g") : e.bar.insert("g", ":first-child"), e.bar.attr("class", K.chartBars).call(this.setCssRule(!1, `.${K.chartBars}`, ["pointer-events:none"])), t.clipPath === !1 && (t.bar_radius || t.bar_radius_ratio) && e.bar.attr("clip-path", n.pathXAxis.replace(/#[^)]*/, `#${n.id}`));
	},
	updateTargetsForBar(e) {
		...
		yi.call(t, e, {
			type: "Bar",
			elKey: "bar",
			containerClass: K.chartBars,
			itemClass: K.chartBar,
			initFn: t.initBar
		}).append("g").attr("class", r).style("cursor", (e) => i?.bind?.(t.api)(e) ? "pointer" : null).call((e) => {
			t.setCssRule(!0, ` .${K.bar}`, ["fill"], t.color)(e), e.each(function(e) {
				Ga.call(t, e.id) && o(this).append("path").attr("class", K.barConnectLine);
			});
		});
	},
	updateBar(e, t = !1) {
		...
		let l = o.main.selectAll(`.${K.bars}`).selectAll(`.${K.bar}`).data(n.labelishData.bind(n));
	...
	generateUpdateBarColor() {
		...
		return (n) => vi.call(e, n, "bar_linearGradient", t);
	},
	updateBarColor(e) {
	...
	redrawBar(e, t, n = !1) {
		...
		let { bar: i } = n ? r.$el.subchart : r.$el, a = [], s = /* @__PURE__ */ new Map(), c = Ba(r), l = r.generateUpdateBarColor(), u = function(i, c, l) {
			let u = N(i.value) || r.isBarRangeType(i) || r.isSubchartCandlestickBarValue?.(i, n) ? e(i, c) : [""], d = s.get(i.id);
			if (d === void 0 && (d = Ga.call(r, i.id), s.set(i.id, d)), u.length > 1 && a.push(u[1]), c === l.length - 1 && a.length) {
				let e = r.$T(o(this.parentNode.querySelector(`.${K.barConnectLine}`)), t, rt());
				r.updateConnectLine(e, d, a), a.splice(0);
			}
			return u[0];
		}, d = r.$T(i, t, rt());
		return c && typeof d.attrTween == "function" ? d.attrTween("d", function(e, t, n) {
			let r = u.call(this, e, t, n);
			return za(this.getAttribute("d") ?? "", r);
		}) : d.attr("d", u), [d.style("fill", (e) => r.getSubchartCandlestickBarColor?.(e, n) || l(e)).style("clip-path", (e) => e.clipPath).style("opacity", null)];
	},
	generateDrawBar(e, t) {
		let n = this, { config: r } = n, i = n.generateGetBarPoints(e, t), a = Ba(n), o = a ? Va(n) : /* @__PURE__ */ new Set(), s = /* @__PURE__ */ new Map();
		return (e, t) => {
			let c = i(e, t), { indexX: l, indexY: u, isNegative: d, pos: f, radius: p, clipPath: m } = Wa(n, e, c, a, o, n.isStackingRadiusData.bind(n)), h = ["", ""];
			if (e.clipPath = m, a) {
			...
			return v === void 0 && (v = Ga.call(n, e.id), s.set(e.id, v)), v && _.push(r.axis_rotated ? {
				x: c[0][l],
				y: c[0][u],
				width: c[0][l] - f,
				height: c[2][u] - c[0][u]
...
function Za(e, t) {
	let n = this.internal, { config: r } = n, i = r.transition_duration && Mt(), a = `grid_${t}_lines`;
	return e ? (r[a] = Ya(e), n.state.isCanvasMode ? (Xa(n), r[a]) : (n.updateGrid(), n.redrawGrid(i), r[a])) : r[a];
}
function Qa(e, t) {
	let n = `grid_${t}_lines`;
	return Za.bind(this)(this.internal.config[n].concat(e ? Ya(e) : []), t);
}
function $a(e, t) {
	let n = this.internal;
	if (n.state.isCanvasMode) {
		let r = n.getGridFilterToRemove?.(e) || (() => !0), i = `grid_${t ? "x" : "y"}_lines`;
		n.config[i] = n.config[i].filter((e) => !r(e)), Xa(n);
		return;
	}
	n.removeGridLines(e, t);
}
var eo = function(e) {
	return Za.bind(this)(e, "x");
};
Xe(eo, {
	add(e) {
		return Qa.bind(this)(e, "x");
	},
	remove(e) {
		return $a.bind(this)(e, !0);
	}
});
var to = function(e) {
	return Za.bind(this)(e, "y");
};
Xe(to, {
	add(e) {
		return Qa.bind(this)(e, "y");
	},
	remove(e) {
		return $a.bind(this)(e, !1);
	}
});
var no = {
	xgrids: eo,
	ygrids: to
}, ro = `line.${J.xgridFocus}:not(.${J.xgridFocusContinuous}), line.${J.ygridFocus}`, io = (e) => A(e.position) || "end", ao = (e) => e.position === "start" ? 4 : e.position === "middle" ? 0 : -4;
function oo(e) {
	let { state: t, $el: { main: n } } = e, r = t._gridFocusEl, i = n.node(), a = r?.nodes?.() || [];
	return a.length && a.every((e) => i?.contains(e)) ? r : t._gridFocusEl = n.selectAll(ro);
}
function so(e) {
	e.$el.main.select(`line.${J.xgridFocusContinuous}`).style("visibility", "hidden");
}
function co(e, t, n) {
	return (r) => {
		let i = e ? 0 : t;
...
var uo = {
	...
	initGridLines() {
		...
		(e.grid_x_lines.length || e.grid_y_lines.length) && (n.gridLines.main = n.main.insert("g", `.${W.chart}${e.grid_lines_front ? " + *" : ""}`).attr("clip-path", t.pathGrid).attr("class", `${Y.grid} ${Y.gridLines}`), n.gridLines.main.append("g").attr("class", Y.xgridLines), n.gridLines.main.append("g").attr("class", Y.ygridLines), n.gridLines.x = gt([]));
	},
	updateXGrid(e) {
		...
		i.xgridAttr = c ? {
			...
			y1: 0,
			y2: i.height
		}, s.x = a.select(`.${Y.xgrids}`).selectAll(`.${Y.xgrid}`).data(l), s.x.exit().remove(), s.x = s.x.enter().append("line").attr("class", Y.xgrid).merge(s.x), e || s.x.each(function() {
			let e = o(this);
	...
	updateYGrid() {
		...
		a.y = o.select(`.${Y.ygrids}`).selectAll(`.${Y.ygrid}`).data(l), a.y.exit().remove(), a.y = a.y.enter().append("line").attr("class", Y.ygrid).merge(a.y), a.y.attr("x1", s ? c : 0).attr("x2", s ? c : i.width).attr("y1", s ? 0 : c).attr("y2", s ? i.height : c), lo(a.y, "grid");
	},
	updateGrid() {
	...
	updateGridLines(e) {
		...
		let l = i.select(`.${Y[`${e}gridLines`]}`).selectAll(`.${Y[`${e}gridLine`]}`).data(n[`grid_${e}_lines`]);
		...
		}), a(l.attr("class", (t) => `${Y[`${e}gridLine`]} ${t.class || ""}`.trim()).select("text").attr("text-anchor", io).attr("transform", () => c ? s ? null : "rotate(-90)" : s ? "rotate(-90)" : null).attr("dx", ao).attr("dy", -5)).text(function(e) {
	...
	redrawGrid(e) {
		...
		return l = o(l, e).attr("x1", n ? 0 : s).attr("x2", n ? r : s).attr("y1", n ? s : 0).attr("y2", n ? s : i), u = o(u, e).attr("x", co(!n, r, i)).attr("y", s), d = o(d, e).attr("x1", n ? c : 0).attr("x2", n ? c : r).attr("y1", n ? 0 : c).attr("y2", n ? i : c), f = o(f, e).attr("x", co(n, r, i)).attr("y", c), [
	...
	initFocusGrid() {
		...
		t._gridFocusEl = null;
		let i = e.grid_front, a = `.${i && r.gridLines.main ? Y.gridLines : W.chart}${i ? " + *" : ""}`, o = r.main.insert("g", a).attr("clip-path", n.pathGrid).attr("class", Y.grid);
		if (r.grid.main = o, e.grid_x_show && o.append("g").attr("class", Y.xgrids), e.grid_y_show && o.append("g").attr("class", Y.ygrids), e.axis_tooltip) {
		...
		e.interaction_enabled && e.grid_focus_show && !e.axis_tooltip && (o.append("g").attr("class", J.xgridFocus).append("line").attr("class", J.xgridFocus), e.grid_focus_y && !e.tooltip_grouped && o.append("g").attr("class", J.ygridFocus).append("line").attr("class", J.ygridFocus), e.subchart_grid_focus_continuous && e.subchart_grid_focus !== !1 && r.main.insert("g", a).attr("class", J.xgridFocusContinuous).append("line").attr("class", `${J.xgridFocus} ${J.xgridFocusContinuous}`).style("visibility", "hidden"));
	},
	showAxisGridFocus() {
		let e = this, { config: t, format: n, state: { event: r, width: i, height: a } } = e, s = t.axis_rotated, [c, l] = Ct(r, e.$el.eventRect?.node()), u = {
			x: c,
			y: l
		};
	...
	hideAxisGridFocus() {
		let e = this;
		e.$el.main.selectAll(`line.${G.axisTooltipX}, line.${G.axisTooltipY}`).style("visibility", "hidden"), Object.values(e.$el.axisTooltip).forEach((e) => e?.style("display", "none"));
	},
	showGridFocus(e) {
		let t = this, { config: n, state: { width: r, height: i } } = t, a = n.axis_rotated, s = oo(t), c = (e || [s.datum()]).filter((e) => e && A(t.getBaseValue(e)));
		...
		}), lo(s, "grid"), t.showCircleFocus?.(e);
	},
	hideGridFocus(e = !1) {
		let t = this, { state: { inputType: n, resizing: r } } = t;
		(e || n === "mouse" || !r) && (oo(t).style("visibility", "hidden"), so(t), t.hideCircleFocus?.());
	},
	updateGridFocus() {
		let e = this, { state: { inputType: t, width: n, height: r, resizing: i }, $el: { grid: a } } = e, o = a.main.select(`line.${J.xgridFocus}`);
		if (t === "touch") o.empty() ? i && e.showCircleFocus?.() : e.showGridFocus();
		else {
			let t = e.config.axis_rotated;
			o.attr("x1", t ? 0 : -10).attr("x2", t ? n : -10).attr("y1", t ? -10 : 0).attr("y2", t ? -10 : r), so(e);
		}
		return !0;
	},
	generateGridData(e, t) {
		let n = this, r = n.$el.main.select(`.${G.axisX}`).selectAll(".tick").size(), i = [];
		if (e === "year") {
	...
	getGridFilterToRemove(e) {
		return e ? (t) => {
			let n = !1;
			return (R(e) ? e.concat() : [e]).forEach((e) => {
				("value" in e && t.value === e.value || "class" in e && t.class === e.class) && (n = !0);
			}), n;
		} : () => !0;
	},
	removeGridLines(e, t) {
		let n = this, { config: r, $T: i } = n, a = n.getGridFilterToRemove(e), o = (e) => !a(e), s = t ? Y.xgridLines : Y.ygridLines, c = t ? Y.xgridLine : Y.ygridLine;
	...
	grid_front: !1,
	grid_lines_front: !0
}, po = () => (Xe(wi.prototype, uo), Ii.prototype.xgrids = no.xgrids, Ii.prototype.ygrids = no.ygrids, cn.setOptions([fo]), (po = () => ({}))()), mo = Object.create(null), ho = {
	version: "4.1.0",
	generate(e) {
		let t = new Ii($e(Object.create(null), mo, e));
...
function go(e, t) {
	let n = e.series.map((e) => [e.name, ...e.values]), r = ho.generate({
		...po(),
		axis: { x: {
...
//#endregion
export { go as renderBillboardJS };
